...
else
{
	...
	$fee12=execute("select uid from  fee_m_descrption where class='$FromYear' and accyear='$a_year' and adm_cat='$fee_type' ");
	$uid1=fetchrow($fee12);
	if($uid1[0])
	$uid=$uid1[0];
...
if(isset($_POST['save']))
{
	...
	{
		$sql="INSERT INTO  fee_m_descrption (`uid`, `class`, `accyear`, `adm_cat`, `no_of_instal`,  `no_of_student`,`status`,`currency`) VALUES ('$uid', '$FromYear', '$a_year', '$fee_type', '$intl', '0', '1','$currency')";
	}
	execute($sql);
