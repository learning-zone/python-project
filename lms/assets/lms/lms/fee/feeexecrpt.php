...
<body>
<form name='frm' method='post' action='feecol4.php'>
<table class='forumline' border=1 align=center width="80%">
<tr height="30"><td align=center class=head colspan=4>FEE COLLECTION REPORT</TD></TR>
<?php	
$cdt1=date("d");
$cmt1=date("m");
$cyr1=date("Y");
...
?><br>
<div align='center'>
	<input type='submit' name='viewrpt' value='VIEW' class="bgbutton">
</div>
<?php
