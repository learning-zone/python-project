...
function send()
{
	...
	document.frm.action='bankchfee1.php';
	document.frm.submit();
}
function frm_reload()
{
	document.frm.action='bankchfee.php';
	document.frm.submit();
} 
</script>
<?php
...
if($num > 0)
{
	...
	<center>
    <table class='forumline' align='center' ><tr><td Class="Head" colspan='2' align='center'>Bank Challan Report</td></tr>
    </center>
	<tr height='30'>
	<td>Program </td>
		<td>
