...
$rs1=fetcharray(execute("select year_name,year_id from course_year where year_id='$sql[sid]'"));
...
?>
<tr><td align='right' colspan='2'>Total&nbsp;&nbsp;</td><td align='right'><?=number_format($ttl1,2)?></td>
<td align='right'><?=number_format($ttl2,2)?></td><td align='right'><font color='red'><b><?=number_format($ttl3,2)?></b></font></td></tr>
<?php
if($sql[cenamt]>0)
{
	?>
	<tr><td align='right' colspan='4'>Concession Amount&nbsp;&nbsp;</td><td align='right'><?=number_format($sql[cenamt],2)?></td></tr>
	<tr><td align='right' colspan='4'>Due Amount&nbsp;&nbsp;</td><td align='right'><font color='red'><b><?=number_format(($ttl3-$sql[cenamt]),2)?></b></font></td></tr>
	<?php
}
?>
</table><br>
<div id="prn" align="center"><input type="button" name="prnfeest" value="<< PRINT >>" onclick="prnfee()"></div>
<div id='1'><font color='brown'><b><< <a href='duerpt1.php?pid=<?=$sql[pid]?>&sid=<?=$rs1[1]?>'>BACK</a></b></font><div>
</form>
</body>
</html>