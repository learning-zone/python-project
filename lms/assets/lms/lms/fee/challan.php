...
<table width="90%" align="center" class="head1" border="3" cellspacing="0" cellpadding="5" >
  ...
  <tr>
    ...
    <tr>
        <td nowrap="nowrap"><div style="background-image:url(http://www.ecole.myschoolone.com/renew/images/EcoleWatermark1.png)">
        <table height="200" align="center" background="" border="0" cellpadding="5" cellspacing="0" width="100%" >
                <tr bgcolor="#CCCCCC">
