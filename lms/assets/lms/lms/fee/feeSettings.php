...
if($_POST['save'])
{
	...
	//INSERT INTO `fee_collection_settings` ( `invoicedate`, `duedate`, `eur`, `usd`, `remark1`, `remark2`, `remark3`, `accyear`, `status`) VALUES ( '2013-03-19', '2013-03-29', '65.9999', '45.666', 'rrrrrrrrrrrr', 'tttttttttttttttttt', 'yyyyyyyyyyyyyyyyyyyy', '2012', '1');
	$sql2=execute("select * from  `fee_collection_settings` where `accyear`='$addyear'");
	if(rowcount($sql2)>=1)
	{
		$sql44="update `fee_collection_settings` set `invoicedate`='$date1', `duedate`='$date2', `eur`='$eur', `usd`='$usd', `remark1`='{$rmk1}', `remark2`='{$rmk2}', `remark3`='{$rmk3}'  where accyear='$addyear'";

	}
	else
	{
		
		$sql44="INSERT INTO `fee_collection_settings` ( `invoicedate`, `duedate`, `eur`, `usd`, `remark1`, `remark2`, `remark3`, `accyear`, `status`) VALUES ( '$date1', '$date2', '$eur', '$usd', '{$rmk1}', '{$rmk2}', '{$rmk3}', '$addyear', '1')";
	}
		execute($sql44);
		?>
...
<tr>
    <td colspan="2" align="center" class="head">Fee Settings</td>
  </tr><!--  <tr>
