...
function exportexl()
{
	document.frm.action="confee2.php?branch=$branch&sem=$sem&sect=$sect";
	document.frm.submit();
}
</SCRIPT>
</head>
...
<tr>
<td align='center' class='head' colspan='3'><font size="4"><b>Consolidated Fee Report</b></font></td></tr>
<tr height='30'>
<td nowrap>&nbsp;&nbsp;Curriculam : <?=$prmname[0]?></td>
<td nowrap>&nbsp;&nbsp;CLass : <?=$semname[0]?></td>
<td nowrap>&nbsp;&nbsp;Section : <?=$sectname?></td></tr>
<tr><td colspan='3'>
<table class='forumline' border='1' width='100%' cellspacing='0' cellpadding='1'>
<tr height='25'><td Class="rowpic" align='center'>Sl.No</td>
<td Class="rowpic" align='center' nowrap>SR Number</td>
...
for($i=0;$i<rowcount($rs);$i++)
{
	...
	if(rowcount($feem)>0)
	{
		...
		<?php
			...
			echo "<td align='right'>$f[ptfee1]</td>";
			$totalpaidamt=$totalpaidamt+$f['ptfee1'];
			$tl[$nn]+=$ttlpd;
			$nn++;
			if($f[balamt]>0)
			{
...
echo "<tr><td colspan='3' align='right'>Total&nbsp;&nbsp;&nbsp;</td><td><strong>$totalpaidamt</strong></td>
<td><strong></strong></td>
<td><strong></strong></td>
<td><strong></strong></td>";
for($j=1;$j<=$nt;$j++)
