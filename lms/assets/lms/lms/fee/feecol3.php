...
echo "</tr>";
$sql=execute("select * from fee_payment where pid='$pid' and sid='$sid' and ins_dt between '$fmyr1' and '$toyr1' and recptstatus=0 and studid='$studid'");
$sno=1;
...
<div id='1'><font color='brown'><b><< <a href='feecol2.php?pid=<?=$pid?>&sid=<?=$sid?>&fmyr1=<?=$fmyr1?>&toyr1=<?=$toyr1?>'>BACK</a></b></font><div>
<?php
