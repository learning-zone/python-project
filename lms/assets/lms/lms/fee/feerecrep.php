...
<tr><td align='center' class='head' colspan='8'>Student wise  Fee Register   
</td>
</tr>
<tr height='30'>
...
for($i=0;$i<rowcount($rs);$i++)
{
	...
	if($grade!=$grade1)
	{
		...
		?>
		<tr><td align='center' class='rowpic' colspan='8'><?=$cname[0]?></td></tr>
		<?php
	}
	$fg=1;
		if($sno<10)
...
if($r[receipt]=='1230')
{
//	echo "$sd1[0]-$sd2[0]-$sd3[0]-$sts1[0]-$sts2[0]-$sts3[0]";		
}
		...
		echo "<td align='right'>$sumtot $currencydes[0]</td>";
		$sno++;
		$grade1=$r[division];
