<?php
	...
	$r=fetcharray(execute("select a.id,a.student_id,a.first_name,a.last_name,a.admission_type,a.course_admitted,a.course_yearsem,a.academic_year,a.class_section_id, a.adm_yr , a.admission_id from student_m a,fee_apply_fee_student b  where a.archive='N' and b.acc_year='$a_year' and a.id=b.student_id and b.status='1' and b.division='$sem' and a.id='$stud_id'"));
	...
	else
	{
		...
		$invId=$maxid[0]+1;
		$invoiceid="INV/$stud_yr"."$r[admission_id]/$invId";
...
header("Content-Disposition: attachment; filename=$invoiceid.doc");
...
<table width="90%" align="center" class="head1" border="3" cellspacing="0" cellpadding="5" >
  ...
  <tr>
    ...
    <tr>
        <td nowrap="nowrap">
        <table height="200" align="center" background="http://www.ecole.myschoolone.com/renew/images/EcoleWatermark.png" border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr bgcolor="#CCCCCC">
...
<INPUT TYPE="button" class=bgbutton NAME="print" VALUE="PRINT " onclick='prn()'></div>
