...
<tr><td align='center' class='head' colspan='5'><font size="4"><b>Student List</b></font></td>
</tr>
<tr height='30'>
...
$sno=1;
	...
	<tr height='23'><td align='center'><?=$sno?></td>
		<td>&nbsp;&nbsp;&nbsp;
		   <A HREF="javascript:OpenWind('refundfee.php?stud_id=<?php echo $r[id]?>&course=<?php echo $r[course_admitted] ?>&sem=<?php echo $r[course_yearsem] ?>&adm_id=<?php echo $r[admission_id] ?>');"><?php echo $r[student_id] ?></A>		
		  </td>
