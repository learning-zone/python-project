...
function exportexl()
{
	document.frm.action="dtchrpt2.php?fmyr=$fmyr&fmyr1=$fmyr1&toyr=$toyr&toyr1=$toyr1&paymode=$paymode&bkid=$bkid";
	document.frm.submit();
}
</SCRIPT>
</head>
...
echo "<input type='hidden' name='fmyr' value='$fmyr'>";
echo "<input type='hidden' name='fmyr1' value='$fmyr1'>";
echo "<input type='hidden' name='toyr' value='$toyr'>";
echo "<input type='hidden' name='toyr1' value='$toyr1'>";
echo "<input type='hidden' name='paymode' value='$paymode'>";
echo "<input type='hidden' name='bkid' value='$bkid'>";
...
if($dtdiff>=0)
{
	...
	{
		?>
		<table border='0' class='forumline' align=center cellspacing='0' cellpadding='0' width='95%'>
