...
<tr height="30"><td align=center class=head colspan=<?=$cnt?>><font size='3'>FEE COLLECTION REPORT</font></TD></TR>
...
echo "</tr>";
$sql=execute("select * from fee_payment where pid='$pid' and sid='$sid' and ins_dt between '$fmyr1' and '$toyr1' and studid='$studid' order by id");
$sno=1;
while($r=fetcharray($sql))
{
	...
	if($r[recptstatus]==0)
		echo "<td><font color='blue'>&nbsp;&nbsp;$r[docid]</td>";
	else
		echo "<td><font color='red'>&nbsp;&nbsp;$r[docid]</td>";
...
<div id='1'><font color='red'><b>Note : Receipt No in red already cancelled.</b></font></div><br>
<div id="prn" align="center"><input type="button" name="prnfeest" value="<< PRINT >>" onclick="prnfee()"></div>
<div id='1'><font color='brown'><b><< <a href='feesum2.php?pid=<?=$pid?>&sid=<?=$sid?>&fmyr1=<?=$fmyr1?>&toyr1=<?=$toyr1?>'>BACK</a></b></font><div>
<?php
