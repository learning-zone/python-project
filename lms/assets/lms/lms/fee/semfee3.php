	...
	if(rowcount($feem)>0)
	{
		...
		while($d=fetcharray($ff))
		{
			...
			else
			{
				...
				{
					if($d[mop]==2)
						$bkdt="DD-".$dd[0].",".$d[ddno].",".$dddt;
					else
						$bkdt="CH-".$dd[0].",".$d[ddno].",".$dddt;
				}
				else
