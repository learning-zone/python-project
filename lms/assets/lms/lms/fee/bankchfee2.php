...
$sql.="and a.class_section_id='$sect' and a.archive='N' and a.course_admitted=b.pid and b.mop=3 and a.id=b.studid and b.accyr='$cyr1' order by b.bkid ";
$rs=execute($sql) or die(mysql_error());
if(rowcount($rs)==0)
{
	echo "<font color=brown><b>No Challan Payment..!!</b></font>";
	die();
}
else
{
	?>
	<table border='1' class='forumline' align=center cellspacing='0' cellpadding='0'>
	<tr><td align='center' class='head' colspan='3'><font size="4"><b>Bank Challan Report</b></font></td></tr>
	...
	while($r=fetcharray($rs))
	{
		...
		<tr><td colspan='6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='brown'><b><?=$sql1[0]?></b></font></tr>
		<tr height='25'><td Class="rowpic" align='center'>Sl.No</td><td Class="rowpic" align='center' nowrap>SR Number</td><td Class="rowpic" align='center' nowrap>Student Name</td><td Class="rowpic" align='center' nowrap>Challan No</td><td Class="rowpic" align='center' nowrap>Challan Date</td><td Class="rowpic" align='center' nowrap>Amount</td></tr>	
		<?php
		...
		$sql2.="and b.mop=3 and a.id=b.studid and b.bkid='$r[0]' and b.accyr='$cyr1' order by a.first_name";
		...
		while($r1=fetcharray($rs1))
		{
			...
			echo "<td width='15%' nowrap>&nbsp;&nbsp;$dddt</td>";
			$amt=number_format($r1[5],2);
			$ttlamt+=$r1[5];
			echo "<td align='right' width='15%'>&nbsp;&nbsp;$amt</td></tr>";
			$sno++;
			$no++;
		}
		$amt=number_format($ttlamt,2);
		$gdttl+=$ttlamt;
		echo "<tr><td align='right' colspan='5'><b>Total Amount</b>&nbsp;&nbsp;</td><td align='right'>$amt</td></tr>";
		echo "</table></td></tr>";
	}
	$amt=number_format($gdttl,2);
	echo "<tr><td align='right' colspan='2'><font color='red'><b>Grand Total&nbsp;&nbsp;</b></font></td><td align='right'><font color='red'><b>Rs. $amt</b></font></td></tr>";
	echo "</table><br><br>";
}
?>
