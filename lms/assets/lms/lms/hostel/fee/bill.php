...
<BODY>
<CENTER>
<FORM METHOD="POST" ACTION="bill.php" NAME="frm" onSubmit="return formSubmit(this.form)">
...
$sql  = "SELECT id, s_id, first_name, last_name, domain FROM ";
	...
	echo "<TABLE CELLPADDING='0' CELLSPACING='0' BORDER='0' WIDTH='40%' CLASS='forumline'>";
	echo "<TBODY>";
