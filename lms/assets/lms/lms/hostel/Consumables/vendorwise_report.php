...
<body>
<form method="post" name=frm action="vendorwise_report1.php">
<table border=0 class='forumline' align=center>
<tr><td Class=head colspan=2 align=center>View Vendorwise Report</td></tr>
<tr>
...
<br>
<center><input type="submit" value="View Report" class='bgbutton'></center>