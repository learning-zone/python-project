...
function reload1()
{
	document.frm.action='ConsolidateReportexl.php';
	document.frm.submit();
...
?>	
  ...
  <tr>
    <td colspan="2" align="center" class="head" nowrap>Consolidate Report card</td>
  </tr>
  <tr height="25">
...
<br>
<div align="center"><input type="button" name="open" class="bgbutton" value="Export Excel" onClick="reload1()"></div>			
</form>
</body>
</html>
