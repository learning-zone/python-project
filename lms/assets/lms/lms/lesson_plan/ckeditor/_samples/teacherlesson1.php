...
<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;
<a href= "teacherlesson.php?title_id=<?=$title_id?>&subject=<?=$subject?>"><input type='button' align='center' class='bgbutton' value='Menu'></a></div>
<br>

<table align="center" width="30%" border="0" cellspacing="0" cellpadding="5">
<tr>
    <td align="center" class="head" colspan="2"><?=$title_name1[0]?></td>
</tr> 

<tr>
    <td align="center" class="rowpic" colspan="2"><b><?=$unit_name1[0]?></b></td>
</tr> 

</table>
<br>
<br>
<table align="center" width="30%" border="1" cellspacing="0" cellpadding="10">
<tr><td align='center' class="head" colspan="2">Title</td></tr>

<?
//lesson master title
$s=1;
$lesson_name=mysql_query("select sub_title,id from lms_lesson_master where title_id='$title_id' and sub='$subject' and unit_id ='$unit' and status=1");
...
?>
    ...
    <td align="left" >&nbsp;&nbsp;&nbsp;&nbsp;<a href="teachmodify.php?unit=<?=$unit?>&title_id=<?=$title_id?>&subtitle_id=<?=$lesson_name1[1]?>&subject=<?=$subject?>"><b><?=$lesson_name1[0]?></b></a></td></tr> 
<?
$s++;
}
?>
