...
<form class="new1" action="studmodify.php" method="post" ENCTYPE="multipart/form-data">
<?php
...
{ 
    ...
    if($master1[4]==1 || $master1[4]==2)
    {
		...
		?>
		   ...
		   <iframe src="http://docs.google.com/gview?url=http://mbis.myschoolone.com/renew/lesson_plan/ckeditor/_samples/lmsintroduction/<?=$img_path?>&embedded=true" style="width:900px; height:600px;" frameborder="0"></iframe>
        <?
		}
    }
	else
  	{
		if($master1[0])
		{
			...
			$img_path=$img_path[1];	
		?>
		    <iframe src="http://mbis.myschoolone.com/renew/lesson_plan/ckeditor/_samples/lmsintroduction/<?=$img_path?>" style="width:900px; height:600px;" frameborder="0"></iframe>
        <?
		}
    }
?>
