...
<form class="new1" action="studlesson1.php" method="post" ENCTYPE="multipart/form-data">
<?php
...
?>
    ...
    <td align="left" >&nbsp;&nbsp;&nbsp;&nbsp;<a href="studmodify.php?unit=<?=$unit?>&title_id=<?=$title_id?>&subtitle_id=<?=$lesson_name1[1]?>&subject=<?=$subject?>"><b><?=$lesson_name1[0]?></b></a>
    </td>
    </tr> 
<?
$s++;
