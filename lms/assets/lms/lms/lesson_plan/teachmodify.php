...
<form class="new1" action="teachmodify.php" method="post" ENCTYPE="multipart/form-data">
<?php
echo "
...
<tr>
 ...
 <?php
$master=execute("select img_source,description,sub_title,summary,file_type from lms_lesson_master where unit_id='$unit' and title_id='$title_id' and sub='$subject' and status=1 and id='$subtitle_id'");
...
{ 
    ...
    if($master1[4]==1 || $master1[4]==2)
    {
		...
		?>
		   ...
		   <iframe src="http://docs.google.com/gview?url=http://mbis.myschoolone.com/renew/lesson_plan/ckeditor/_samples/lmsintroduction/<?=$nameimage?>&embedded=true" style="width:900px; height:600px;" frameborder="0"></iframe>
        <?
		}
    }
	else
  	{
		...
		?>
		    <iframe src="http://mbis.myschoolone.com/renew/lesson_plan/ckeditor/_samples/lmsintroduction/<?=$nameimage?>" style="width:900px; height:600px;" frameborder="0"></iframe>
        <?
		}
    }
?>
...
<br>
	<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;
<a href= "ckeditor/_samples/lmsintroduction/download.php?img_path=<?=$nameimage?>"><input type='button' align='center' class='bgbutton' value='download'></a></div>
</div>
