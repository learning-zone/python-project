...
-->      
        ...
        <td align='center' nowrap >&nbsp;<?=$r6['time_limit']?></td>
        <td align="center" nowrap>
       <a href= "javascript:OpenWind2('viewamnt.php?amnt=<?=$r6['id']?>&subject=<?=$subject?>')">
<input type="button"  value="View"  class='bgbutton'></a>
</td>
       </tr>
	<?php	
    $i=$i+1;
