	...
	$k=1;
...

		{
            ...
            <tr >
                ...
                <a href="javascript:void(0);" onClick ="OpenWind2('add_questions1.php?id=<?=$r1[1]?>&examname=<?=$r1[0]?>', 'OpenWind2',1000,600)"><input type="button" name="update" value="Add Questions"  class='bgbutton'></a>
                ...
                <a href="javascript:void(0);" onClick ="OpenWind2('add_questions2.php?id=<?=$r1[1]?>&examname=<?=$r1[0]?>', 'OpenWind2',1000,600)"><input type="button" name="update" value="Add Questions"  class='bgbutton'></a>
