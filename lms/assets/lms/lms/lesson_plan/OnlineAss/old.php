...
if($save)
{
	$temsql=execute("select * from online_exam_master where class_id='$FromYear'  and exam_name='$ename' and acc_year='$accyear'");
	...
	else
	{
		...
		$inser=execute("INSERT INTO `online_exam_master` (`class_id`, `acc_year`, `exam_name`, `exam_short_name`, `status`) VALUES ('$FromYear', '$accyear', '$ename', '$descr', '1')");
		$examiddet=mysql_fetch_row(execute("select max(id) from online_exam_master"));
