...

{
	...
	{ 
...

		{
			...
			<td align="left" background="../bg4.png">&nbsp;&nbsp;&nbsp;&nbsp;<a href="teacherlesson.php?unit=<?=$menu?>&menu=<?=$menu?>&title_id=<?=$title_id?>&subtitle_id=<?=$lesson_name1[1]?>&subject=<?=$subject?>&type=<?=$unit1[2]?>&sem=<?=$sem?>&class_section_id=<?=$class_section_id?>"><b><?=$lesson_name1[0]?></b></a>
...
<?php
...

	{
		...
		<iframe width="900" height="600" src="teachmodify.php?unit=<?=$unit?>&subtitle_id=<?=$subtitle_id?>&title_id=<?=$title_id?>&subject=<?=$subject?>&type=<?=$menutype1[0]?>&sem=<?=$sem?>&class_section_id=<?=$class_section_id?>"></iframe>
...

	{
		...
		<iframe width="900" height="600" src="teacview.php?unit=<?=$menu?>&title_id=<?=$title_id?>&subject=<?=$subject?>&type=<?=$menutype1[0]?>&sem=<?=$sem?>&class_section_id=<?=$class_section_id?>"></iframe>
...

	{
		...
		<iframe width="900" height="600" src="introview.php?unit=<?=$menu?>&title_id=<?=$title_id?>&subject=<?=$subject?>&type=<?=$menutype1[0]?>&sem=<?=$sem?>&class_section_id=<?=$class_section_id?>">
