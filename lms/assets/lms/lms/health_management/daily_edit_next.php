...
$doc_detail_id=$_POST['doc_detail_id'];
	$gj=execute("update doc_detail set doc_name='{$doct}',d_date='".addslashes($dts)."',time='".addslashes($timr)."',complaints='".addslashes($txtPresenting)."',treatment='".addslashes($txtTreatment)."',remarks='".addslashes($txtRecommendations)."',place='$place',time_1='".addslashes($timr1)."',type='$type',report='$report',m_date='$today',entered_date='$today1' where id='$id'");
...
<script>
...

       {
          ...
          document.frmMedicaldetail.action='daily_edit_stud.php';
...

{
    ...
    document.frmMedicaldetail.action="daily_edit_studs.php";
...
?>
		      <form name="frmMedicaldetail" method="post" action='daily_edit_next.php'>
    ...
    <input type="hidden" name="id" value="<?=$id?>">
			...
			Edit Daily Treatment Report </td>
...
<?php
$test=execute("select time from doc_detail where stud_id='$stud'");
...
<?php
$test=execute("select time_1 from doc_detail where stud_id='$stud'");
 ...
 <?php
  ...
  ?>
        ...
        <input type="radio"  name="type" value="yes" <?=$check?>>Home
          ...
          <input type="radio"  name="type" value="no" <?=$check2?>>None
