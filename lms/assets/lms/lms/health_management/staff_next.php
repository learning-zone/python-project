...
function reload2()
{
	...
	{
		document.frmMedicaldetail.action='staff_next.php';
...
function frmMedicaldetail_submit1()
  {
	...
	document.frmMedicaldetail.submit();
                        ...
                        <form name="frmMedicaldetail" method="post" action='staff_next.php'>
			...
			Staff Accident Report For  - <?php echo $stud?></td>
				...
				<?php
				     if(isset($gob))
				     {
					   ...
					   $hospital_name = $_POST['hospital_name'];
						...
						$hosp=$_POST['hosp'];
						$type=$_POST['type'];
				       $c=execute("select * from accident_report_staff where slno='$aa' and d_date='$ddv' and staff_id='$stud'");
