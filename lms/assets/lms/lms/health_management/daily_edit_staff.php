...
function cli()
{
   document.frm.action='daily_edit_staff.php';
   document.frm.submit();
}
function reload()
{
   document.frm.action='daily_edit_staffs.php';
   document.frm.submit();
}
</script>
...
<body>
<p>&nbsp;</p>
<form name='frm' method='post' action='daily_edit_staffs.php'>
<table  align=center width='35%'>
<tr><td align=center colspan=2 class=head>Edit Staff Sick Report</td></tr>
<tr><td >&nbsp;Select Staff Group </td>
<td><select name="staf" onchange='cli()'>
...
<td><select name="stafd" onchange='reload()'>
<option value='0'>---Select---</option>
<?php
