...
function cli()
{
	document.form1.action="sick_stud.php";
...
<table  class='forumline' cellspacing=0 width="90%" align=center> 
    ...
    while($ddf=fetcharray($df))
    {
		...
		<td align=center><a href='sick_next.php?id=<?=$ddf[id]?>&stud=<?php echo $ddf[student_id]?>&grade=<?php echo $ddf[course_admitted]?>&ad=<?php echo $ddf[academic_year]?>&ag=<?php echo $h?>&gen=<?php echo $ss?>&adm=<?php echo $ddf[admission_type]?>&branch=<?php echo $ddf[course_admitted]?>&class_section_id=<?php echo $class_section_id?>&sem=<?php echo $sem?>'>
