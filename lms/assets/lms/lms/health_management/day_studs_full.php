...
<table class='forumline' cellspacing=0 width="90%" align=center> 
		...
		<tr><td align=center nowrap>&nbsp;Student Name</td>
            ...
            <td align=center nowrap>&nbsp;View</td>
	...
	{	
		...
		<tr>
			...
			<!--<td align="center">&nbsp;&nbsp;&nbsp;<?php echo $ddf[age]?></td>
...
<td align="center"><a href="javascript:OpenWind2('add_staff_med1.php?studentid=<?=$studentid?>')" >View
