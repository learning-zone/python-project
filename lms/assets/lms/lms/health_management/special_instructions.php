...
function cli()
{
	document.form1.action="special_instructions.php";
...
<body>
<p>&nbsp;</p>
<form name="form1" method="post" action="special_instructions.php">
  <table class='forumline' align='center' width="90%" >
<tr>
  <td align=center colspan=4  class=head>Special Instructions Report</td></tr>
	<tr height='30'>
...
<table  class='forumline' cellspacing=0 width="90%" align=center> 
    ...
    while($ddf=fetcharray($df))
    {
		...
		<td align=center><a href="javascript:OpenWind2('special_instructions_nxt.php?student_id=<?=$ddf[id]?>&stud=<?php echo $ddf[student_id]?>&grade=<?php echo $ddf[course_admitted]?>&ad=<?php echo $ddf[academic_year]?>&ag=<?php echo $h?>&gen=<?php echo $ss?>&adm=<?php echo $ddf[admission_type]?>&branch=<?php echo $ddf[course_admitted]?>&class_section_id=<?php echo $class_section_id?>&sem=<?php echo $sem?>')" >
