...

{
	...
	window.open(finalVar,'Staff','width=900,height=550,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no');
			...
			<tr>
			<td vAlign="top" align="Center" height="30"  colspan=4 class=head>Edit Daily Treatment Details for - <?php echo $fn?></td>
...
<input type="button" class="bgbutton" value="View medical information">
				 ...
				 //echo "select * from doc_staff where staff_id='$staff_id' and d_date='$dts' and slno='$stud'";
                              ...
                              $rfg=execute("select * from doc_staff where staff_id='$staff_id' and d_date='$dts' and slno='$stud'");
			      $fgb=fetcharray($rfg);
