...
<table  class='forumline' cellspacing=0 width="55%" align=center> 
		...
		<?php
		       ...
		       $df=execute("select * from staff_det where active='YES' and type_id='$stafd'");
		...
		<tr>
			<td >&nbsp;<?php echo $fn?></td>
			<td align=LEFT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='daily_staff_next.php?stud=<?php echo $fn?>&staff_id=<?php echo $staff_id?>&gen=<?php echo $ss?>&stafd=<?php echo $ddf[type_id]?>&aa=<?php echo $ddf[slno]?>&staf=<?php echo $ddf[group_id]?>'>
