...
<table class='forumline' cellspacing=0 width="90%" align=center> 
	...
	{	
		...
		$studentid=$r['id'];
		  ...
		  $df=execute("select * from accident_report where stud_id='$studentid' group by stud_id");
...
$dv=execute("select id,d_date  from accident_report where stud_id='$studentid'");
