...
function RefreshMe(val)
	{
		...
		document.frmMedicaldetail.action="daily_treatment_stud.php";
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<form name="frmMedicaldetail" method="post" ENCTYPE="multipart/form-data" action='daily_treatment_stud.php'>
