...
<table  align="center" width="80%" border="1" cellpadding="0" cellspacing="0">
			...
			<tr class="submenu">
            <td vAlign="top" align="Center" colspan=7 class=head>List Of Boys Taken To Hospital
            </td>
            <tr>
 ...
 $df=execute("select a.*,b.id,b.first_name,b.last_name,b.course_yearsem,c.stud_id from hospital_det a,student_m b,doc_detail c where c.stud_id=b.id and c.id=a.doc_detail_id and c.type='no' and b.gender='M' group by c.stud_id");
			  $SlNo = 1;
