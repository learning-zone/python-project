...
function reload()
{
	document.frm.action='edit_staff_next.php';
	document.frm.submit();
}
</script>
...
<body>
<p>&nbsp;</p>
<form name='frm' method="POST" action='edit_staff_next.php'>
...
<table border=1  align=center width="70%"> 
		...
		<?php
		       $df=execute("select * from accident_report_staff");
		...
		<tr>
			...
			<td align=center><select style="WIDTH: 185px" name="dts" onchange='reload()'>
					...
					$dv=execute("select * from accident_report_staff slno='$ddf[slno]'");
