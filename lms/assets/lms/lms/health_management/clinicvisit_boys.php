...
<table  align="center" width="85%" border="1" cellpadding="0" cellspacing="0">
 ...
 $df=execute("SELECT a . * , b.id, b.first_name, b.last_name, b.course_yearsem FROM student_m b, doc_detail a WHERE a.stud_id = b.id AND b.gender = 'M' and a.d_date BETWEEN  '$adate' AND  '$bdate'");
...
FROM student_m b, accident_report a WHERE a.stud_id = b.id AND b.gender = 'M' and a.d_date BETWEEN  '$adate' AND  '$bdate'");
