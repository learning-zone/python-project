...
<tr>
	   ...
	   <td class="keycell" >&nbsp;Medical History&nbsp;:</td>
...
$testvat=execute("select dname from staff_health where staff_id='$staff_id' and status=1");
while($testvat1=fetcharray($testvat))
{
$teschwck=fetcharray(execute("select * from staff_med_frm where id='$testvat1[0]' order by id"));
