...
<body>
<form name='frm' method="POST" action='accident_day_stud.php'>
...
<table border='1'  width="90%" align='center' cellpadding="0" cellspacing="0"> 
		<tr><td colspan=9 align=center class=head>ACCIDENT REPORT RECORD</td></tr>
		<tr class="submenu">
		...
		<?php
			  ...
			  $df=execute("select a.*,b.first_name,b.last_name,b.course_yearsem from accident_report a,student_m b where a.d_date between '$penal_from' and '$penal_to' and a.stud_id=b.id");
			  $SlNo = 1;
