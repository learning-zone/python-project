...
function reload()
{
	...
	{
		document.frm.action='daily_sick_stud.php';
		document.frm.submit();
	}
	else if(document.frm.mtype.value=='2')
	{
		document.frm.action='daily_sick_staff.php';
		document.frm.submit();
	}
	else if(document.frm.mtype.value=='3')
	{
		document.frm.action='daily_sick_other.php';
		document.frm.submit();
	}
...
<tr><td align=center colspan=2 class=head>Daily Treatment Details</td></tr>
