...
<script type="text/javascript">
	...
	{
	document.frm.action="class_create1.php?sem="+token;
	document.frm.submit();
	}
</script>
...
<script type="text/javascript">
	...
	{
	document.frm.action="class_create1.php?type=secl";	
	document.frm.submit();
	}
</script>
...
<script type="text/javascript">
	function reloadme()
	{
	document.frm.action="class_create1.php";
	document.frm.submit();
	}
</script>
...
<form Name="frm" action="class_create1.php" method="post">   
...
<tr>
 <td valign="top" width="20%" nowrap rowspan="2"><b>Course</b><br>
    ...
    <img src="button-add.png" align="top" title="Add Course"></a>&nbsp;
    <?
	}
	else
	{
	?>
    <img src="button-add.png" align="top" title="Add Course" onClick="subjectnot()">&nbsp;
    <?
	}
	?>
    </td>
...
<td valign="top"  nowrap rowspan="3">
   ...
   {
	?>
    <img src="button-add.png" align="top" title="Add Section" onClick="sectionnot()">
    <?
   }
	?>
      <br> 
...
<div style="overflow: auto;height:200px; width:550px;" align="center">
  ...
  { 
		...
		$section_info=fetchrow(execute("select section_name,codename from class_section where sub='$subject' and id='$section'"));
 ...
 <tr>
    ...
    <td nowrap align='center' nowrap>&nbsp;<?=$r1[student_id]?></td>
...
<td>
    <?
		...
		echo "select sub_teac2,sub_teac,home_teac from all_teachers where sub='$subject' and section='$section' and acc_year='$academic_year' and class='$sem56'";
	?>
    <b>Faculty 1</b>&nbsp;<br>
    <select name="sub_teacher" STYLE="width:150px;" onChange="reloadme()">
    ...
    <br>
    <br>
    <b>Faculty 2</b>&nbsp;<br><select name="class_teacher" STYLE="width:150px;" onChange="reloadme()">
        	<option value="">Assign Faculty</option>
	<?php
    ...
    <br>
    <br>
    <b>Homeroom Teacher</b>&nbsp;<br><select name="home_teacher" STYLE="width:150px;" onChange="reloadme()">
        	<option value="">Assign Faculty</option>
	<?php
