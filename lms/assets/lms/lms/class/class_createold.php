...
<tr>
 <td valign="top" width="20%" nowrap rowspan="2"><b>Course</b><br>
    ...
    <select name="section"  onChange="reloadme()" multiple STYLE="width:150px;height:150px">
		<?
        $sect12.="select id,section_name,codename from class_section where sub='$subject'"; 
		if($sem!='')
		{
...
<div style="overflow: auto;height:200px; width:550px;" align="center">
   ...
   $sql123.="select id,student_id,first_name,last_name,admission_id from student_m where id is not null and archive='N' and academic_year='$academic_year' ";
	...
	if($section!='')
	{
	$sql123.=" and class_section_id=$section  ";
	}
...
$sql5=execute("select id,sub,sub_sec from student_course where acc_year='$academic_year' and stu_id='$r1[id]' and sub='$subject' and sub_sec='$section'");
  ...
  if($checkiddet[0]!='' or $checkiddet[0]!=0)
  {
		...
		$section_info=fetchrow(execute("select section_name,codename from class_section where sub='$subject'"));
