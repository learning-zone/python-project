...
<script  LANGUAGE="JavaScript">
	function reloadme()
	{
		document.frm.action="class_reportold.php";
		document.frm.submit();
	}
		function prn()
		{
...
$i++;  }
  ...
  $allstrud = "select a.id,a.codename,a.section_name,a.sub,a.grade,b.stu_id from class_section a,student_course b where a.status=1 and a.id=b.sub_sec and b.acc_year='$academic_year' group by a.id,b.stu_id order by a.grade,a.codename,a.section_name ";
