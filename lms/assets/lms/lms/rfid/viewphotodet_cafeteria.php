...

{
	...
	<?=$viewsetss[first_name]?>&nbsp;<?=$viewsetss[last_name]?></a>&nbsp;&nbsp;&nbsp;
     ...
     <a href="javascript:void(0);" onClick ="OpenWind3('../rfid/cafeteria_det.php?StudID=<?=$stid?>', 'OpenWind3',800,500)"><input type="button" class="bgbutton" value="Personalize" name="Personalize"></a>
...

{
   ...
   <!-- </a>-->
    ...
    &nbsp;&nbsp;&nbsp;
     ...
     <a href="javascript:void(0);" onClick ="OpenWind3('../rfid/cafeteria_detf.php?StudID=<?=$stid?>&cnfm_id=d1', 'OpenWind3',800,500)"><input type="button" class="bgbutton" value="Personalize" name="Personalize"></a>
    ...
    <!--</a>--> &nbsp;&nbsp;&nbsp;
     ...
     <a href="javascript:void(0);" onClick ="OpenWind3('../rfid/cafeteria_detm.php?StudID=<?=$stid?>&cnfm_id=m1', 'OpenWind3',800,500)"><input type="button" class="bgbutton" value="Personalize" name="Personalize"></a>
   ...
   <!-- </a>--> &nbsp;&nbsp;&nbsp;
     ...
     <a href="javascript:void(0);" onClick ="OpenWind3('../rfid/cafeteria_detc.php?StudID=<?=$stid?>&cnfm_id=g1', 'OpenWind3',800,500)"><input type="button" class="bgbutton" value="Personalize" name="Personalize"></a>
