...

{
	...
	window.open(finalVar,'Staff','width=1100,height=800,status=yes,toolbar=no,scrollbars=yes,menubar=no,location=no');
...
<body topmargin="15" leftmargin="5" onLoad="start()">
    ...
    <form method="POST"  action="cafeteria_staff.php" name="frm">
     <table  width="90%" align="center" border="1">
<tr>
<td Class="head" colspan=6 align=center >Generate ID Card</td>
</tr>
...
<br>
<center>		   <td><input type="submit" value="Search" name="B1" class='bgbutton' onClick="reload()"></td></center>
<br>
	...
	if(empty($f_name)  && ($subj=="0") && empty($staff_id))
{
        ...
        die("Please select proper details!! ");
}
	...
	function delete_me(id1)
	{
		...
		<form method='post' action="cafeteria_staff.php"  name="frm1" >
...
?>
	<table border="0" width="90%" cellpadding="0" class="forumline" align="center">
      <tr><td Class="head" colspan=4 align=center>Generate ID Card</td></tr>
	  </table>
	<div align='center'>
	<table border='1'  align="center" width="90%">
	 
	<td class="row3" align='LEFT' nowrap>SL.No
		 </td>
	...
	<td class="row3" align='LEFT'>
		Department</td>
	<td  class="row3" align='LEFT' width='35'>
	Designation</td>
        <td  class="row3" align='LEFT'>
	Action</td>
	...
	for($i=0;$i<$num;$i++)
	{
		...
		<td  class="CBody" align="center">&nbsp;<?php echo $designation?> </td>
	<!--	<td class="CBody" align="left"><font face='Lucida Sans' ><?php //echo $ex?> Years</font></td>-->
    <td>
    <div id=123B style="float: right; text-align: right;">
<a href="javascript:OpenWind3('cafeteria_personalise_staff.php?id1=<?=$r["id"]?>')" >
Personalise
		...
		<!--<td  class="CBody" align="CENTER">
			<a Style='text-decoration: none; ' href='personalise_staff.php?id1=<?php echo $r["id"]?>'>Personalise</a>
			</td>--></tr>
		<?php
	}
}
