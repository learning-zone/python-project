...
{
	?>
	<form method='post' action="stud_behaviour_sel.php" name="frm" >
...
<?php
  ...
  $sno=1;
	for($i=0;$i<rowcount($rs);$i++)
	{
		...
		<td align="center">
        <a href="stud_behaviour_add.php?StudID=<?php echo $r[id]?>&app_num=<?php echo $app_num ?>&class_section_id=<?php echo $class_section_id ?>&branch=<?php echo $branch ?>&sem=<?php echo $sem ?>&studfname=<?php echo $studfname ?>&a_year=<?php echo $a_year ?>&un=<?php echo $un ?>"><?=$r[student_id]?></a></td>
