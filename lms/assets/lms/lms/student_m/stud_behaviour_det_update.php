...
if(isset($_POST['Update']))
{
      ...
      $sql="UPDATE `student_behaviour_type` SET `student_id` = '$StudID', `reported_by`='$reported_by', `adate` = '$yy_mm_dd', `behaviour`='$subject', `description`= '$description', `notes`='$notes' WHERE `id`= '$BID' AND `student_id`= '$StudID'";
	  //echo $sql;
	...
	$result=execute("SELECT * FROM `student_behaviour_type` WHERE `id`= '$BID' AND `student_id`= '$StudID'");
...
<body>
<br>
<form name="frm" method="POST" action="stud_behaviour_det_update.php" >
...
<p align="center"><input name="Update" type="submit" value=" Update "  class="bgbutton"/></p>
