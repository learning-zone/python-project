...

{
	...
	window.open(finalVar,'Stud','width=900,height=550,status=yes,toolbar=yes,scrollbars=yes,menubar=yes,location=no');
...

{
	...
	document.frm.action='reportskg.php';
...
?>
  ...
  echo "<tr>
	...
	?><a href= "javascript:OpenWind2('reportskg1.php?course=<?=$branch?>&sem=<?=$sem?>&examid=<?=$examname?>&studentid=<?=$r1[id]?>&class_section_id=<?=$class_section_id?>&stundetname=<?=$r1[first_name]?>&student_id=<?=$r1[student_id]?>')">Print		
...
<a href= "javascript:OpenWind2('reportskgword.php?course=<?=$branch?>&sem=<?=$sem?>&examid=<?=$examname?>&studentid=<?=$r1[id]?>&class_section_id=<?=$class_section_id?>&stundetname=<?=$r1[first_name]?>&student_id=<?=$r1[student_id]?>')">Export Word		
