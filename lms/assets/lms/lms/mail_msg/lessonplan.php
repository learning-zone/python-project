...
if($_POST['SendMSG'])
{
	...
	while($r3=fetcharray($sql3))
	{
		...
		$sql24=execute("select topic , description from teacher_lesson_plan where subj='$r3[0]' and  r_date='$rdate' and sec='$class_section_id' and parent_r=1");
...
if($log1=1)
{
	?>
			<SCRIPT LANGUAGE="JavaScript">
			alert("lesson plan not available 	");
			</SCRIPT>
	<?php
die();
