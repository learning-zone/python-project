...
document.write('<table cellspacing=0 cellpadding=0 border=0><tr><td>');
document.write('<a href="reports.php" target="_self" title="" class="topitem8">Reports</a>');
document.write('</td><td><p class="SMN8"><font face="webdings" color=#0C0B0A></font></p></td></tr></table>');
document.write('</td>');
document.write('<td align=center background="s1.gif">&nbsp;</td>');
...
document.write('<table cellspacing=0 cellpadding=0 border=0 width="100%"><tr><td width="90%" align="LEFT">');
document.write('<a href="settings.php" target="_self" title="" class="subitem8" >Service Tax</a>')
;document.write('</td><td><p class="SMN8">&nbsp;</p></td></tr></table>');
document.write('</td>');
document.write('</tr>');
document.write('<tr>');
...
document.write('<table cellspacing=0 cellpadding=0 border=0 width="100%"><tr><td width="90%" align="LEFT">');
document.write('<a href="company.php" target="_self" title="" class="subitem8" >Company Details</a>')
;document.write('</td><td><p class="SMN8">&nbsp;</p></td></tr></table>');
document.write('</td>');
document.write('</tr>');
document.write('</table></div>');
...
//document.write('<table cellspacing=0 cellpadding=0 border=0 width="100%"><tr><td width="90%" align="LEFT">');
//document.write('<a href="inventoryReports.php" target="_self" title="" class="subitem8" >Reports</a>');
//document.write('</td><td><p class="SMN8">&nbsp;</p></td></tr></table>');
//document.write('</td>');
//document.write('</tr>');
document.write('</table></div>');
