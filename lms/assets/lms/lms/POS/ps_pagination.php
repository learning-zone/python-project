...
class PS_Pagination {
	 ...
	 * @return string
	 */
	function renderFirst($tag = '<font style="font:normal 12px verdana"><b>First</b></font>') {
		if ($this->total_rows == 0)
			return FALSE;
	 ...
	 * @return string
	 */
	function renderLast($tag = '<font style="font:normal 12px verdana"><b>Last</b></font>') {
		if ($this->total_rows == 0)
			return FALSE;
	...
	function renderNav($prefix = '<span class="page_link">', $suffix = '</span>') {
		...
		for($i = $start; $i <= $end; $i ++) {
			if ($i == $this->page) {
				$links .= '<font style="font:normal 14px verdana"><b> ' . $prefix . " $i " . $suffix . '</b></font> ';
			} else {
				$links .= '<font style="font:normal 12px verdana"><b> ' . $prefix . '<a href="' . $this->php_self . '?page=' . $i . '&' . $this->append . '">' . $i . '</a>' . $suffix . '</b></font> ';
			}
		}
