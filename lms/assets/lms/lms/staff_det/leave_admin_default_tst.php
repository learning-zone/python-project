...
<?
	if($p==111){
		?>
        <li  class="currentBtn"><a href="leave_admin_default_tst.php?tab=111" >Pending Default</a></li>
        <?
	}else{
		?>
        <li><a href="leave_admin_default_tst.php?tab=111" >Pending Default</a></li>
        <?
	}
?>
<?
	if($p==222){
		?>
        <li  class="currentBtn"><a href="leave_admin_default_tst.php?tab=222" >Approved Default</a></li>
        <?
	}else{
		?>
        <li><a href="leave_admin_default_tst.php?tab=222" >Approved Default</a></li>
        <?
	}
?>
<?
	if($p==333){
		?>
        <li  class="currentBtn"><a href="leave_admin_default_tst.php?tab=333" >Rejected Default</a></li>
        <?
	}else{
		?>
        <li><a href="leave_admin_default_tst.php?tab=333" >Rejected Default</a></li>
        <?
	}
?>
</ul>
