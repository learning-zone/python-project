...
-->	<td class="row3" align='center' nowrap>SL.No</td>
	...
	<td class="row3" align='center' nowrap><a href="<?php echo "staffrfidupdate.php?sort_by=f_name&sort_type=ASC&subj=$subj";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Name<a href="<?php echo "staffrfidupdate.php?sort_by=f_name&sort_type=DESC&subj=$subj";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a></td>

	<td class="row3" align='center' nowrap><a href="<?php echo "staffrfidupdate.php?sort_by=EmployeeCode&sort_type=ASC&subj=$subj";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Staff Id<a href="<?php echo "staffrfidupdate.php?sort_by=EmployeeCode&sort_type=DESC&subj=$subj";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font>
</a></td>

	<td class="row3" align='center' nowrap>RFID</td>

	<td class="row3" align='center' nowrap>Department</td>

	<td  class="row3" align='center' nowrap>Designation</td>
</tr>
 	<?php
...
$sql2 ="SELECT COUNT(id) ".$tempsql1;
 ...
 if($page==1)
  ...
  echo "<a href='staffrfidupdate.php?page=1&sort_by=".$sort_by."&sort_type=".$sort_type."&subj=".$subj."' title='Click to go to First page..'  > First </a> &nbsp;";

 $prv=$page-1;

 if($prv>0)
  echo "<a href='staffrfidupdate.php?page=".$prv."&sort_by=".$sort_by."&sort_type=".$sort_type."&subj=".$subj."' title='Click to go to Previous page..'  > Previous </a> &nbsp;";
 else
  echo "&#9668;";
 ...
 if($nxt<=$total_pages)
  echo "<a href='staffrfidupdate.php?page=".$nxt."&sort_by=".$sort_by."&sort_type=".$sort_type."&subj=".$subj."' title='Click to go to Next page..'  > Next </a> &nbsp;"; 
 else
  echo "&#9658;";
 ...
 if($page==$total_pages)
  ...
  echo "<a href='staffrfidupdate.php?page=".$total_pages."&sort_by=".$sort_by."&sort_type=".$sort_type."&subj=".$subj."' title='Click to go to Last page..' >Last</a> &nbsp;";
