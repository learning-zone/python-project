...
function reload1()
{
	...
	document.frm.action='modify.php'; 
	document.frm.submit();
}
function reload2()
{
...
{
	if(validate_me()){
		document.frm.action='modifyStaff.php';
		document.frm.submit();
	}else{
		return false;	
	}
...
$r=fetcharray($sql);
?>
<form method="POST" name="frm" action="modify.php" enctype="multipart/form-data">
<input type="hidden" name="id1" value="<?php echo $id1?>">
  <table width="90%" border="0" align="center" cellpadding="0">
 
   <tr>
   <td colspan="4" align="center" class="head" >Modify Staff Members Details</td>
          </tr>
          <tr>
          ...
          <td  align="left">
            <input type="text" name="emp_id" size="20" value="<?php echo $r[EmployeeCode]?>">
         </td>
          <td  align="left">&nbsp;</td>
          <td  align="left">&nbsp;
...
?>
        ...
        <tr>
          ...
          <td height="25" align="left">
            <input type="text" name="email" size="40"value="<?php echo $r[email]?>">
          </td>
        </tr>
       <tr>
      ...
      <table width="100%" cellspacing="4" cellpadding="0" border="0" align="left" class="forumline">
        ...
        <tr>
          ...
          <td width="37%" height="27"  align="left">
            <select name="subj" size="1" style="width:150px;">
...
?>
          ...
          <td align="left" height="27">
            <input type="text" name="slno"  value="<?php echo $r["slno"]?>">
          </td>
        </tr>
        <tr>
          <td align="left" height="25">&nbsp;&nbsp;Staff Group</td>
          <td align="left" height="25"><select size="1" name="staff_group"  style="width:150px;">
              <option value="0">-- Select --</option>
              <?php 
...
<!--          <td width="26%" align="left" height="25"><select size="1" name="sstatus" onChange="sho()"> -->
          <td width="26%" align="left" height="25"><select size="1" name="sstatus" >
              <option value="0">-- Select --</option>
              <?php
...
?>
		...
		<td height="25" align="left">&nbsp;&nbsp;Swap Card Number</td>
          <td height="25" align="left">
            <input type="text" name="scard" size="20" value="<?php echo $r[scard]?>">
          </td>
...
$tempr="";
$tempr1="";
if($r[recruitment_procedure]=="User")
{
	$tempr="selected";
	$tempr1="";
}
elseif($r[recruitment_procedure]=="Nonuser")
{
	$tempr1="selected";
	$tempr="";
}
...
?>
        ...
        <tr align="center">
          ...
          <td align="left">
            <textarea name="other_facilities" rows=4 cols=30><?php echo $r[other_facilities]?></textarea>
          </td>
          <td width="16%" align="left" valign="top">Responsibilities</td>
          <td width="37%" align="left">
            <textarea name="other_responsibilities" rows=4 cols=30><?php echo $r[other_responsibilities]?></textarea>
          </td>
        </tr>
        <tr>
        <td>
        ...
        $leavtype=execute("select leave_name,id from staff_leave_type where status=1 and special_type='2'");
	...
	<tr>
              <td  align="center" height="25" >&nbsp;&nbsp;<img src="<?php echo $r[img_col]?>" width="100px" height="120px;" />
			  <?php			  
			  $imgpth="../staff_images/";
			  ?>
			  ...
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:OpenWind('../photobooth/index.php?phid=<?=$r[id]?>&phpath=<?=$imgpth?>')"><img "../staff_images/temp/".$phid.".jpg"  title="Click to Capture Photo" border="1"></img></a></td>
        

			              <td  align="center" height="25" ><input type='FILE' name='uploadedfile' value="" size='15'></td>
						  <td colspan='2'>&nbsp;</td>
		  </tr>
      <tr height='50' valign='bottom'>
        <td ><input type="checkbox" name="archive" >
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Archive</td>
        <?php
		  $tesnmasr=fetcharray(execute("select `hr_id`, `mng_id` from `staff_hr_grup` where staff_id='$id1' and status=1"));
		   $hr=$tesnmasr[0];
		   $mangs=$tesnmasr[1];
		  ?>
        <td nowrap> 
    ...
    <?php
    $sqlSub2=execute("SELECT b.f_name,b.s_name,b.id FROM staff_leave_hr a,staff_det b where a.hr_id=b.id and status=1 and b.id!='$id1' order by  b.f_name");
    while($r12=fetcharray($sqlSub2))
    {
    if($hr==$r12[id])
    echo "<option value=$r12[id] selected>$r12[f_name] $r12[s_name]</option>";
    else
    echo "<option value=$r12[id]>$r12[f_name] $r12[s_name]</option>";
    }
    ?>
    </select></td>
    <td nowrap>
   ...
   <select name="mangs" >
    ...
    <?php
    $sqlSub=execute("SELECT b.f_name,b.s_name,b.id FROM staff_leave_manger a,staff_det b where a.manger_id=b.id and status=1  and b.id!='$id1'   order by  b.f_name");
    while($r1=fetcharray($sqlSub))
    {
    if($mangs==$r1[id])
    echo "<option value=$r1[id] selected>$r1[f_name] $r1[s_name]</option>";
    else
    echo "<option value=$r1[id]>$r1[f_name] $r1[s_name]</option>";
    }
    ?>
    </select>
   </td>
    ...
    <br>
<table border="0" cellspacing="2" cellpadding="0" class="forumline" width="90%" align="center">
...
?>
    ...
    <tr>
      <td colspan="4">
        ...
        <table width="90%" cellspacing="2" cellpadding="0" border="0" align="CENTER" class="forumline">
          <tr>
...
?>
    ...
    <tr>
      <td colspan="4">
        ...
        <table class="forumline" align=center width="90%" align="center">
          <tr>
