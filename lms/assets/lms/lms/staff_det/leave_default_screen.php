...
//////////////////////end///////////////////////	
	...
	if(strtotime($leave_pay_inserts[0])<strtotime($from_date_pay) && mysql_num_rows($manager_admin)<1 && $staffrigtss[0]!='admin')
   {
	   ?>
...
<ul class="tabHead">
        ...
        <li><a href="leave_withdrwn_screen.php?tab=123" >Withdrawn</a></li>
...
<?
	if($p==111){
		?>
        <li  class="currentBtn"><a href="leave_default_screen.php?tab=111" >Pending Default</a></li>
        <?
	}else{
		?>
        <li><a href="leave_default_screen.php?tab=111" >Pending Default</a></li>
        <?
	}
?>
<?
	if($p==222){
		?>
        <li  class="currentBtn"><a href="leave_default_screen.php?tab=222" >Approved Default</a></li>
        <?
	}else{
		?>
        <li><a href="leave_default_screen.php?tab=222" >Approved Default</a></li>
        <?
	}
?>
<?
	if($p==333){
		?>
        <li  class="currentBtn"><a href="leave_default_screen.php?tab=333" >Rejected Default</a></li>
        <?
	}else{
		?>
        <li><a href="leave_default_screen.php?tab=333" >Rejected Default</a></li>
        <?
	}
?>
</ul>
