<?php
$file_name= "Staff_Attendance_Report.xls";
...
<tr>
  ...
  <tr>
    <td align="center" class="head" nowrap="nowrap">Sl</td>
    <td align="center" class="head" nowrap="nowrap">Name</td>
    <td align="center" class="head" nowrap="nowrap">Staff ID</td>
<?php
 for($c=0;$c<$tot_day;$c++)
{
...
?>
 <td align="center" class="head" nowrap="nowrap"><?=$viewdate_att?></td>
<?php
}
?>
 <td align="center" class="head" nowrap="nowrap">Working Days</td>
    <td align="center" class="head" nowrap="nowrap">Paid Days</td>
    <td align="center" class="head" nowrap="nowrap">School Holidays</td>
    <td align="center" class="head" nowrap="nowrap">Total Paid Days</td>
<?php	
$tot_work_holiday='0';
$tot_work_sunday='0';

$staffname=execute("select f_name,s_name,slno,group_id,id from staff_det where  active='YES'  and (recruitment_procedure='User' or recruitment_procedure='') order by f_name limit 10");
$s=1;
...
//$out_timeview='';
	...
	{
		echo "<div align='center' style='color:#F60'><b>PM : SHL</b></div>";
	}
	else
	{
