...
{
        print("<font color=red><b>Please enter details!! <a href='Promotion.php'> Back to Search Form</a></font>");
}
else
{
	$SQL = "SELECT distinct f_name,id,slno,staff_status_id,s_name,subj,type_id FROM staff_det WHERE active='YES'";
	...
	<tr><td  class="row3" align='center'><strong><font face='Lucida Sans' size='1.8'>Staff Id</font></strong></td>
	...
	<td  class="row3" align='center' colspan=2><strong><font color='brown' face='Lucida Sans' size='1.8'>Action</font></strong></td></tr>
	<?php
	for($i=0;$i<$num;$i++)
	{
		$r = fetcharray($rs,$i);
		?>
		<tr height='25'><td  class="CBody"><font face='Lucida Sans' size='1.5'>&nbsp;&nbsp;&nbsp;<?php echo $r["slno"]?></font></td>
		...
		href='Promotion1.php?id=<?php echo $r["id"]?>'><font face='Lucida Sans' size='1.5'>&nbsp;ADD&nbsp;</font></a></td>
		<td  class="CBody"><a Style='text-decoration: none'
		href='Promotion2.php?id=<?php echo $r["id"]?>'><font face='Lucida Sans' size='1.5'>&nbsp;MODIFY/DELETE&nbsp;</font></a></td></tr>
		<?php
	}
}
?>
