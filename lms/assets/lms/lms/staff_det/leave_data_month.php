...
<body>
    ...
    <tr>
    <td colspan="17" align='center' class="head" nowrap>Paid Leave</td>
    </tr>
    <tr>
    <td align='center' class='rowpic' nowrap>Sl</td>
    <td align='center' class='rowpic' nowrap><a href="<?php echo "leave_data_month.php?sort_by=f_name&sort_type=ASC";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Staff Name<a href="<?php echo "leave_data_month.php?sort_by=f_name&sort_type=DESC";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a></td>
...
$staffname22=execute($staff_name_display);
	...
	while($staff_name_dis1=fetcharray($staffname22))
	{
		...
		$staff_paid_leave=fetcharray(execute("select  Apr_13,May_13,June_13,	July_13,Aug_13,Sep_13,Oct_13,Nov_13,Dec_13,Jan_14,Feb_14,March_14,id from leave_data_m20 where staff_id='$staff_name_dis1[id]'"));
...
<tr><td align="center" nowrap="nowrap" colspan="17">
 ...
 if($page==1)
  ...
  echo "<a href='leave_data_month.php?page=1&sort_by=".$sort_by."&sort_type=".$sort_type."' title='Click to go to First page..'  > First </a> &nbsp;";

 $prv=$page-1;

 if($prv>0)
  echo "<a href='leave_data_month.php?page=".$prv."&sort_by=".$sort_by."&sort_type=".$sort_type."' title='Click to go to Previous page..'  > Previous </a> &nbsp;";
 else
  echo "&#9668;";
 ...
 if($nxt<=$total_pages)
  echo "<a href='leave_data_month.php?page=".$nxt."&sort_by=".$sort_by."&sort_type=".$sort_type."' title='Click to go to Next page..'  > Next </a> &nbsp;"; 
 else
  echo "&#9658;";
 ...
 if($page==$total_pages)
  ...
  echo "<a href='leave_data_month.php?page=".$total_pages."&sort_by=".$sort_by."&sort_type=".$sort_type."' title='Click to go to Last page..' >Last</a> &nbsp;";
