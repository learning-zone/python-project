...
function RefreshMe(val)
	{	
		document.frm.action="staff_leave_count_report.php";
		document.frm.submit();
	}
...
<script>
	...
	function gen_excel()
		{
			document.frm.action='staff_leave_count_report_exl.php';
			document.frm.submit();
		}
	</script>
...
<table width="70%" align="center" class="forumline" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3" align="center" class="head">Select Date</td>
    </tr>
   <tr>
...
$tot_work_holiday='0';
$tot_work_sunday='0';
$staff_name_display="SELECT * from staff_det where  active='YES' and category='$staff_group_id'  and (recruitment_procedure='User' or recruitment_procedure='') order by f_name";
