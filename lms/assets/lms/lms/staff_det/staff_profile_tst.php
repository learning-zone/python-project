...

{
  ...
  document.frm.action='staff_profile_tst.php';
...
$stvstra=0;
 ...
 if($staffrigtss[0]=='admin' && $stvstra=='1')

	{
        ...
        <li class="currentBtn"><a href="staff_profile_tst.php?tab=20" >My Time Sheet</a></li>
...
$leave_test=fetcharray(execute("select approved,reject,type,days,status_approve,f_time,to_time,f_date,t_date  ,status_reason from staff_leave where staff_id='$viewss1[4]' and ( '$newdateval' between f_date and t_date) and status=1 and status_approve!=2"));

$leave_od_ee=fetcharray(execute("select approved,reject,type,days,status_approve,f_time,to_time,f_date,t_date  ,status_reason from staff_leave where staff_id='$viewss1[4]' and hd_ee_da_date='$newdateval' and status=1 and status_approve!=2"));
...
//manger updated att
if($updated_att_staff[0]!='' && $leave_od_ee[2]!='EE' && $leave_od_ee[2]!='6' && $leave_test[4]!='2')
	
	{
		...
		if($updated_att_staff[0]==1 && $updated_att_staff[0]!='0')
		{
		echo "<div align='center' style='color:$view_att_staff[0]'><b>Leave</b></div>";	
		}
		elseif($updated_att_staff[0]!=1 && $updated_att_staff[0]!='0')
		{
...
$leave_staff_diffrence_plc=fetcharray(execute("select time_in,time_out from leave_staff_timing where staff_type='$viewss1[3]' and staff_time_type='1'"));
 $leave_staff_diffrence_pqd=fetcharray(execute("select time_in,time_out from leave_staff_timing where staff_type='$viewss1[3]' and staff_time_type='2'"));
 $leave_staff_diffrence_fhl=fetcharray(execute("select time_in,time_out from leave_staff_timing where staff_type='$viewss1[3]' and staff_time_type='3'"));
 $leave_staff_diffrence_shl=fetcharray(execute("select time_in,time_out from leave_staff_timing where staff_type='$viewss1[3]' and staff_time_type='4'"));
 $leave_staff_diffrence_tqd=fetcharray(execute("select time_in,time_out from leave_staff_timing where staff_type='$viewss1[3]' and staff_time_type='5'"));
 $leave_staff_diffrence_ee=fetcharray(execute("select time_in,time_out from leave_staff_timing where staff_type='$viewss1[3]' and staff_time_type='6'"));
//echo "<br>".$staff_time_attt_in[0];
//echo "<br>".$staff_time_attt_out[0];
//echo "<br>".$viewss1[3];
