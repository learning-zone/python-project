...
<form method="POST"  action="serbook.php" name="frm">
<div align="center"><center>
<table border=1 class="forumline">
<tr><td Class="head" align='center' colspan="4"><font face='Lucida Sans' size='3'>View Service Book Information</font></td></tr>
...
<tr><td><font face="Arial">Status : </font></td><td align='center'>
<select name='sts'><option value='1'>Active</option><option value='2'>Archieve</option>
</select></td>
<td align="right"><font face="Arial">Curricullam : </font></td><td><select  name="subj" size="1">
