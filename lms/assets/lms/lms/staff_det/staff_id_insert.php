...
function RefreshMe(val)
	{	
		document.frm.action="staff_id_insert.php";
		document.frm.submit();
	}
	function gen_excel()
		{
...
<tr>
    <td align="center" colspan="<?=$tot_day+8?>" class="head" nowrap="nowrap">Staff Attendance Report <?=$adate?> - <?=$bdate?></td>
    </tr>
  <tr>
    <td align="center" class="row3" nowrap="nowrap">Sl</td>
    <td align="center" class="row3" nowrap="nowrap"><a href="<?php echo "staff_id_insert.php?sort_by=f_name&sort_type=ASC&adate=".$adate."&bdate=".$bdate."";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Name<a href="<?php echo "staff_id_insert.php?sort_by=f_name&sort_type=DESC&adate=".$adate."&bdate=".$bdate."";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a></td>
    <td align="center" class="row3" nowrap="nowrap"><a href="<?php echo "staff_id_insert.php?sort_by=slno&sort_type=ASC&adate=".$adate."&bdate=".$bdate."";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font></a>Staff ID<a href="<?php echo "staff_id_insert.php?sort_by=slno&sort_type=DESC&adate=".$adate."&bdate=".$bdate."";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a></td>
<?php
 for($c=0;$c<$tot_day;$c++)
{
...
//school holiday
	if(strtotime($staff_calender[0])==strtotime($viewdate_att))
	{
		...
		///insert	
		$staff_paid=execute("select * from leave_staff_attand where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='H',att_point_am='1',att_point_ab_prst='1'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','H','1','1','1','$a_year')");
		}
		///end	
	...
	elseif($updated_att_staff[0])
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='$view_att_staff[1]',att_point_ab_prst_updated='Y',att_point_am='$view_att_staff[2]',att_point_ab_prst='$view_att_staff[2]'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year,att_point_ab_prst_updated) VALUES ('$staffnameview[4]','$viewdate_att','$view_att_staff[1]','1','$view_att_staff[2]','$view_att_staff[2]','$a_year','Y')");
		}
		///end	
	...
	elseif($viewdate_sunday=='Sun')
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='Sun',att_point_am='1',att_point_ab_prst='1'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','Sun','1','1','1','$a_year')");
		}
		///end	
	...
	elseif(strtotime($today_date)>strtotime($viewdate_att))
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='Paid Leave($first_half)',paid_leave='Y',att_point_am='0.5',att_point_ab_prst='0.5'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year,paid_leave) VALUES ('$staffnameview[4]','$viewdate_att','Paid Leave($first_half)','1','0.5','0.5','$a_year','Y')");
		}
		///end	
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='Paid Leave($secnd_half)',paid_leave='Y',att_point_am='0.5',att_point_ab_prst='0.5'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year,paid_leave) VALUES ('$staffnameview[4]','$viewdate_att','Paid Leave($secnd_half)','1','0.5','0.5','$a_year','Y')");
		}
		///end	
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='Paid Leave',att_point_am='1',paid_leave='Y',att_point_ab_prst='1'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year,paid_leave) VALUES ('$staffnameview[4]','$viewdate_att','Paid Leave','1','1','1','$a_year','Y')");
		}
		///end	
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='LWP',att_point_am='0',att_point_ab_prst='0'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','LWP','1','0','0','$a_year')");
		}
		///end
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='Paid Leave',paid_leave='Y',att_point_am='1',att_point_ab_prst='1'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year,paid_leave) VALUES ('$staffnameview[4]','$viewdate_att','Paid Leave','1','1','1','$a_year','Y')");
...
if($count=='0')
{
	if(strtotime($today_date)>strtotime($viewdate_att))
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='$testss',att_point_am='1',att_point_ab_prst='1'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','$testss','1','1','1','$a_year')");
		}
		///end
			$testss='';	
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='$testsa',att_point_am='0',att_point_ab_prst='0'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','$testsa','1','0','0','$a_year')");
		}
		///end
			$testsa='';
		}
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='A',att_point_am='0',att_point_ab_prst='0'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','A','1','0','0','$a_year')");
		}
		///end
...
elseif($count=='1')
{
	...
	if(strtotime($today_date)>strtotime($viewdate_att))
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='$defa_test',att_point_am='1',att_point_ab_prst='1'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','$defa_test','1','1','1','$a_year')");
		}
		///end
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='$defa_testa',att_point_am='0',att_point_ab_prst='0'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','$defa_testa','1','0','0','$a_year')");
		}
		///end
		$defa_testa='';
		echo "<div align='center' style='color:#F00'><b>&#9733; A (0)</b></div>";	
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='Default',att_point_am='0',att_point_ab_prst='0'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','Default','1','0','0','$a_year')");
		}
		///end
...
if(strtotime($staff_time_attt_in[0]) <= strtotime($in_timeview))
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='P',att_point_am='0.5',att_point_ab_prst='0.5'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','P','1','0.5','0.5','$a_year')");
		}
		///end
		$att_am_satus='0.5';	
	...
	else
	{
		...
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_am='P(LC)',att_point_am='0.5',att_point_ab_prst='0.5'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_am,status,att_point_am,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','P(LC)','1','0.5','0.5','$a_year')");
		}
		///end	
		$att_am_satus='0.5';
		$staff_working=$point_five+$staff_working;
	...
	{
		$tot_am_pm=$att_am_satus+'0.5';
		///insert	
		$staff_paid=execute("select * from leave_staff_attand where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		if(mysql_num_rows($staff_paid)>=1)
		{
		execute("update leave_staff_attand set att_code_pm='P',att_point_pm='0.5',att_point_ab_prst='$tot_am_pm'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_pm,status,att_point_pm,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','P','1','0.5','$tot_am_pms','$a_year')");
		}
		///end	
	...
	else
	{
		...
		execute("update leave_staff_attand set att_code_pm='P(EE)',att_point_pm='0.5',att_point_ab_prst='$tot_am_pm'  where status=1 and staff_id='$staffnameview[4]' and ins_date='$viewdate_att' and a_year='$a_year'");
		}
		else
		{
			$tot=$att_am_point+$att_pm_point;	
		execute("INSERT INTO leave_staff_attand (staff_id,ins_date,att_code_pm,status,att_point_pm,att_point_ab_prst,a_year) VALUES ('$staffnameview[4]','$viewdate_att','P(EE)','1','0.5','$tot_am_pm','$a_year')");
		}
		///end	
...
?>
 ...
 <td align="center"  nowrap="nowrap">
    ...
    <b>
	<?php
	if($staff_working_tot)
	{
	echo $staff_working_tot;
	}
	?>
    </b>
    </td>
	...
	?>
        ...
        <td align="center"  nowrap="nowrap">
        <b><?=$final_staff_working?>/<?=$final_working_all?></b></td>
...
?>
<tr>
 <td class="row3"  colspan="<?=$tot_day+8?>">
<?php
 ...
 if($page==1)
  ...
  echo "<a href='staff_id_insert.php?page=1&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to First page..'  > First </a> &nbsp;";

 $prv=$page-1;

 if($prv>0)
  echo "<a href='staff_id_insert.php?page=".$prv."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to Previous page..'  > Previous </a> &nbsp;";
 else
  echo "&#9668;";
 ...
 if($nxt<=$total_pages)
  echo "<a href='staff_id_insert.php?page=".$nxt."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to Next page..'  > Next </a> &nbsp;"; 
 else
  echo "&#9658;";
 ...
 if($page==$total_pages)
  ...
  echo "<a href='staff_id_insert.php?page=".$total_pages."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to Last page..' >Last</a> &nbsp;";
