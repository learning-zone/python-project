...
{?>
  ...
  <?
	$inc=1;
	$temsql3=mysql_query("select * from announcement_call where status=1");
...
if($save=='save')
{
	...
	{
		mysql_query("insert into announcement_call (type,fromdate,todate ,title,description,status,acc_year) values('$type','$fdate','$tdate','$ename','$descr', 1,'$academic_year')");
		?>
		<SCRIPT LANGUAGE="JavaScript">
