...
function RefreshMe(val)
	{	
		document.frm.action="staffdetvew_rprts.php";
		document.frm.submit();
	}
	function gen_excel()
		{
...
<table width="70%" align="center" class="forumline" border="1" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <tr>
    ...
    <option value='1' <?=$grupid1?>>Permanent</option>		
    <option value='2' <?=$grupid2?>>Contractual</option>		
    </select>
     &nbsp;&nbsp;
    No of days >= 
...
{
	?>
  <a href="<?php echo "staffdetvew_rprts.php?sort_by=f_name&sort_type=ASC&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Name<a href="<?php echo "staffdetvew_rprts.php?sort_by=f_name&sort_type=DESC&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a>
<?php
}
else
{
...
{
	?>
    <a href="<?php echo "staffdetvew_rprts.php?sort_by=EmployeeCode&sort_type=ASC&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font></a>Staff ID<a href="<?php echo "staffdetvew_rprts.php?sort_by=EmployeeCode&sort_type=DESC&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a>
    <?php
}
else
{
...
{
  $staff_group_nm='Permanent';
}

if($staffnameview['category']==2)
{
  $staff_group_nm='Contractual';
}
...
<?php
 ...
 if($page==1)
  ...
  echo "<a href='staffdetvew_rprts.php?page=1&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."' title='Click to go to First page..'  > First </a> &nbsp;";
 $prv=$page-1;
 if($prv>0)
  echo "<a href='staffdetvew_rprts.php?page=".$prv."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."' title='Click to go to Previous page..'  > Previous </a> &nbsp;";
 else
  echo "&#9668;";
 echo "&nbsp;(Page $page of $total_pages)&nbsp;";
 $nxt=($page+1); 
 if($nxt<=$total_pages)
  echo "<a href='staffdetvew_rprts.php?page=".$nxt."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."' title='Click to go to Next page..'  > Next </a> &nbsp;"; 
 else
  echo "&#9658;";
 if($page==$total_pages)
  echo "&nbsp;Last&nbsp;";
 else
  echo "<a href='staffdetvew_rprts.php?page=".$total_pages."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."&staff_group_id=".$staff_group_id."' title='Click to go to Last page..' >Last</a> &nbsp;";
  echo "<br>Total $total_records Staff(s)</p>";
?>
