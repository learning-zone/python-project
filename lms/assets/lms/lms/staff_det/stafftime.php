...
<script language="javascript">
	...
	{
		document.frm.action="stafftime.php";
		document.frm.submit();
	}
</script>
...
<?php
$s=1;
$staff_validate=execute(("select c.staff_id from staff_det a,users b,staff_hr_grup c where c.status=1 and b.username='$user' and a.id!='$staffrigtss[1]'  and b.srid=c.mng_id and a.id=c.staff_id and a.active='YES' group by c.staff_id order by a.f_name"));
...
?>
 ...
 <td align="center" nowrap>
    ...
    {
    ?>
    <a href="javascript:void(0);" onClick ="OpenWind2('attvat.php?staffids=<?=$viewss1[4]?>&adate=<?=$adate?>&staff_ids=<?=$staff_ids?>&bdate=<?=$bdate?>&adate_old=<?=$adate?>', 'OpenWind3',400,400)">
    <?php
	if(strtotime($staff_calender[0])==strtotime($viewdate_att))
	{
		$view_holidays='';
	...
	{
    ?>
     <a href="javascript:void(0);" onClick ="OpenWind2('attvat.php?staffids=<?=$viewss1[4]?>&adate=<?=$adate?>&staff_ids=<?=$staff_ids?>&bdate=<?=$bdate?>&staff_ids=<?=$staff_ids?>&adate_old=<?=$adate?>', 'OpenWind3',400,400)">Update</a>
    <?php
	}
	?>
        </td>
...
<table cellspacing="0" cellpadding="0" border="1" align="center" width="100%">
  ...
  <tr>
    <td align="center" class="row3" nowrap="nowrap">Sl No</td>
    <td align="center" class="row3" nowrap="nowrap"><a href="<?php echo "stafftime.php?sort_by=EmployeeCode&sort_type=ASC&adate=".$adate."";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Staff Code<a href="<?php echo "stafftime.php?sort_by=EmployeeCode&sort_type=DESC&adate=".$adate."";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a></td>
    <td align="center" class="row3" nowrap="nowrap"><a href="<?php echo "stafftime.php?sort_by=f_name&sort_type=ASC&adate=".$adate."";?>" title="Click here to Sort ASC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9650;</font>
</a>Staff Name<a href="<?php echo "stafftime.php?sort_by=f_name&sort_type=DESC&adate=".$adate."";?>" title="Click here to Sort DESC" style="text-decoration: none"><font style="font-size:16px; color:#000">&#9660;</font></a></td>
    <td align="center" class="row3" nowrap="nowrap">Expected IN Time<br>(HH:mm)</td>
     <td align="center" class="row3" nowrap="nowrap">Actual IN Time<br>(HH:mm)</td>
   	<td align="center" class="row3" nowrap="nowrap">Expected OUT Time<br>(HH:mm)</td>
    <td align="center" class="row3" nowrap="nowrap">Actual OUT Time<br>(HH:mm)</td>
...
<?php
 ...
 if($page==1)
  ...
  echo "<a href='stafftime.php?page=1&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to First page..'  > First </a> &nbsp;";

 $prv=$page-1;

 if($prv>0)
  echo "<a href='stafftime.php?page=".$prv."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to Previous page..'  > Previous </a> &nbsp;";
 else
  echo "&#9668;";
 ...
 if($nxt<=$total_pages)
  echo "<a href='stafftime.php?page=".$nxt."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to Next page..'  > Next </a> &nbsp;"; 
 else
  echo "&#9658;";
 ...
 if($page==$total_pages)
  ...
  echo "<a href='stafftime.php?page=".$total_pages."&sort_by=".$sort_by."&sort_type=".$sort_type."&adate=".$adate."&bdate=".$bdate."' title='Click to go to Last page..' >Last</a> &nbsp;";
