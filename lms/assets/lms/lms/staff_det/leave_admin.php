...
<?php	
	...
	if($with_date_test > $from_pay_20)
	{
		...
		$topay_mnth=$topay_validate_final[0]."-".$topay_validate_final[1]."-21";
...
//////////////////////end out early exist/////////////////////
?>
 <div style="border:1px solid black;width:95%; background-color:#FFF" align="center">
...
<?
	if($p==99){
		?>
        <li class="currentBtn"><a href="leave_admin_withdrwn_screen.php?tab=123">Withdrawn</a></li>
        <?
	}else{
		?>
 ...
 <td nowrap  align='center'   class="<?=$trcolor?>"  width="8%"><?php echo date("d-m-Y h:i a",strtotime($viewss1[18])); ?></td>
	...
	?></td>
        <td class="<?=$trcolor?>" align="center">
		 ...
		 {
		 ?>
         <a href="javascript:void(0);" onClick ="OpenWind3('date_approval.php?insids=<?=$viewss1[8]?>', 'OpenWind3',900,400)">Date Approval</a></td>
    <?php
		 }
		 }
	?>
...
<tr>
    ...
    <td class="head" align="center" width="10%" nowrap>Status</td>
    <td class="head" align="center" width="10%"  nowrap>Withdrawn Status</td>
...
{
	?>
     <a href="javascript:void(0);" style="text-decoration:none" title="Withdrawn" onClick ="alert('Sorry, The payroll cycle for this month is already completed.\n Hence you are not authorized for this leave.\n Kindly contact your HOD.')">
	...
	{		
		...
		?>	
    <a href="javascript:void(0);" style="text-decoration:none" title="Withdrawn" onClick ="OpenWind3('withdraw_reason.php?id=<?=$r6[0]?>', 'OpenWind3',400,200)">
    <img src="remove.png" width="25%"></a>
    <?php
		}
		}
