...
?><html>
    <head>
        <Script language="JavaScript">            function start() {
    ...
    <body topmargin="15" leftmargin="5" onLoad="start()">
        <form method="POST"  action="search.php" name="frm">
            <table border=0 width="90%" align="center" class="forumline">
                <tr>
                    <td Class="head" colspan=6 align=center >View/Modify Staff Details</td>
                </tr>
                <tr>
                    <td >&nbsp;Staff ID</td>
	...
	if(empty($f_name)  && ($subj=="0") && empty($staff_id))
{
	...
	if($num == 0)
	{
		die("<p align=center>No records found !</p>");
	}
	?>
	<html>
	<head>
	...
	function delete_me(id1)
	{
		...
		<form method='post' action="search.php"  name="frm1" >
