...
<tr><td colspan=6 class="head" align=center>CONTACT INFORMATION OF TEACHING STAFF</td></tr>
...
$sql=execute("select * from staff_group where name like 'Teaching%' and status=1");
$fs=fetcharray($sql);
...
if(rowcount($mm)==0)
{
	echo "No Teaching Staff Records";
	die();
}
$slno=1;
