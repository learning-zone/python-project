...
if($p==4)
{
$values=mysql_query("select a.type,a.f_date,a.t_date,a.days,a.reason,c.f_name,c.s_name,c.slno from staff_leave a,users b,staff_det c where a.status=1 and a.user=b.username and b.srid=c.id");
