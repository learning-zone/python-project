...
if( basename( $_FILES['uploadedfile']['name'])!='')
{
	...
	$SQL1 = "UPDATE staff_det SET f_name='$f_name',s_name='$s_name2',qual='$qual',subj='$subj',dob='$d_o_b',bg='$bg',ms='$ms',";
	$SQL1 .= "addr_pres='".addslashes($addr_pres)."', bank='$bank', religion='$religion' ,category='$category',mobileno='$mobileno',";
	$SQL1.="ct_pres='$ct_pres',pin_pres='$pin_pres',st_pres='$st_pres',type_id='$stype',j_date='$join_date',";
	$SQL1 .= "status_id='$sstatus',staff_status_id='$s_a_status',substantive='$substantive',group_id='$staff_group',gender='$gender',EmployeeCode='$emp_id'";
	...
	$SQL1 .= ",panno='$panno'";
	$SQL1 .= ",tanno='$tanno'";
	$SQL1 .= ",appnt_date='$appnt_date'";
	$SQL1 .= ",recruitment_procedure='$RecPro'";
	if(@$Gender != "")
	{
		$SQL1 .= ",gender='$Gender'";
	}
...
if(!empty($archive))
   {
	...
	$SQLSTR="insert into archive(bank_ac_no,f_name,s_name,qual,cert,subj,exp_cur,exp_prev,sp_assoc,";
	$SQLSTR.="xtra,father,doa,bg,ms,addr_perm,ct_perm,pin_perm,st_perm,ph_perm,addr_pres,ct_pres,";
	$SQLSTR.="pin_pres,st_pres,ph_pres,email,id,slno,group_id,type_id,offeredsal,basicsal,j_date,";
	$SQLSTR.="cmts,status_id,dob,other_facilities,other_responsibilities,prev_post,prev_work_place,";
	...
	$SQLSTR.="$subj,0,$exp_prev,'$assoc','$xtra','$father','$doa','$bg','$ms','$addr_perm','$ct_perm',";
	$SQLSTR.="'$pin_perm','$state_perm','$ph_perm','$addr_pres','$ct_pres','$pin_pres','$state_pres',";
	$SQLSTR.="'$ph_pres','$email',$id1,'$slno1','$staff_group',$stype,$offered,$basic,'$join_date','$cmts',$sstatus,";
...
<SCRIPT LANGUAGE ="JavaScript">
    function reload1()
    {
        document.form1.action="modify.php?id1=<?php echo $id1; ?>";
