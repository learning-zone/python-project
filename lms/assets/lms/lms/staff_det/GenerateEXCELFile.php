		...
		for($i=1;$i<=$num;$i++)
		{
			...
			<td width='50%'>
				<table border="0" width='100%' bordercolor='black'>
					...
					<tr>
						<td colspan='2' align='center'><font size='1.2'>E-mail : demo@vsnl.in</font></td>
						<td align='center'><font size='1.2'>Website : www.demo.in</font></td>
					</tr>
					<tr  height='5'>
					...
					<tr>
						<?php
							$sql=mysql_fetch_array(mysql_query("select course_abbr from course_m where course_id='$r1[course_admitted]'"));
						?>
			...
			<td width='50%' valign='top'>
				<table border='0' width='100%'>				
					...
					<tr>
						<td colspan='3' align='center'><font color='red' size='1.6'>Note : Student must wear their ID card inside the College Premises</font></td>
					</tr>
				</table>
			</td> 
		</tr>
