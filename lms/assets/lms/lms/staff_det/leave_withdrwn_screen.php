...
<ul class="tabHead">
        ...
        <li class="currentBtn"><a href="leave_withdrwn_screen.php" >Withdrawn</a></li>
...
<?
	if($p==123){
		?>
        <li  class="currentBtn"><a href="leave_withdrwn_screen.php?tab=123" >Pending Withdrawn</a></li>
        <?
	}else{
		?>
        <li><a href="leave_withdrwn_screen.php?tab=123" >Pending Withdrawn</a></li>
        <?
	}
?>
<?
	if($p==124){
		?>
        <li  class="currentBtn"><a href="leave_withdrwn_screen.php?tab=124" >Approved Withdrawn</a></li>
        <?
	}else{
		?>
        <li><a href="leave_withdrwn_screen.php?tab=124" >Approved Withdrawn</a></li>
        <?
	}
?>
<?
	if($p==125){
		?>
        <li  class="currentBtn"><a href="leave_withdrwn_screen.php?tab=125" >Rejected Withdrawn</a></li>
        <?
	}else{
		?>
        <li><a href="leave_withdrwn_screen.php?tab=125" >Rejected Withdrawn</a></li>
        <?
	}
?>
</ul>
