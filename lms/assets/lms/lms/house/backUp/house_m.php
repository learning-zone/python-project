...
if($_POST['Submit'])
{
      ...
      $sql="INSERT INTO `house_m` (`name`, `description`, `color`, `date_inserted`, `status`) VALUES ('$name', '$description', '$color_code', CURDATE(), '1')";
	  //echo $sql;
...
<body>
<form name="myForm" method="POST" action="house_m.php" onSubmit="return(validate());">
