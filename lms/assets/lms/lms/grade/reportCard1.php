...
<tr>
	<td align="left"  colspan="2"><b>OIS Grade Brand :</b></td>
</tr>
<tr>
 ...
 while($r=fetcharray($sql))
 {
	...
	else
	{
		...
		/*xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  FOR EDITABLE GRADE xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx */
			...
			//echo "<br>SELECT `category` FROM $tablename WHERE `student_id`='$student_id'";
			
		$studentMarks=fetcharray(execute("SELECT `category` FROM $tablename WHERE `student_id`='$student_id'"));
		
		//echo "<br>".$studentMarks['category'];
...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
  ...
  <table align="center" cellpadding="0" cellspacing="0" width="90%">
     <tr>
        <td><b>OIS Grade Descriptors for Term Marks :</b></td>
     </tr>
     <tr>
        <td><BR>A+ and A</td>
     </tr>
     <tr>
        <td><BR>The student demonstrates a consistent and throught understanding of the required knowledge and skills, and has the ability to apply the knowledge and skills without error in a variety of situations.The student regularly shows evidence of analysis, synthesis and evaluation where appropriate. The student consistency demonstrates originality and insight, and excels in formative and summative assignments.(The student meets and exceeds all required course learing standards.)</td>
      </tr>
	  <tr>
		 <td><BR>B+ and B</td>
	 </tr>
	 <tr>
		<td><BR>The student demonstrated a consistent and thorough understanding of the required knowledge ans skills, and has the ability to apply the knowledge and skills with few errors in a variety of situations.The  student generally shows evidence of analysis, synthesis and evaluation where appropriate, and occasionally demonstrates originally and insight and does well on most formative and summative assignments.(The student meets all course standards and excels at some of the learning standards.) 
		</td>
	</tr>
	<tr>
		<td><BR>C+ and C</td>
	...
	<tr>
		<td><BR>The student has a general understating of the required knowledge and skills, and has some ability to apply the knowledge and skills effectively in normal situations.There is occasional evidence of the skills of analysis, synthesis and evaluation. The student completes most of hte formative and summative assessments.(The student meets all course learning standards.)
		</td>
	</tr>
	<tr>
		<td><BR>D+ and D</td>
	...
	<tr>
		<td><BR>The student has limited understating of the required knowledge and skills and is only able to apply the knowledge and skills fully in normal situations with extensive support.The student has difficulty completing formative and summative assessments.(The student does not meet most of the xourse learning standrads.)
		</td>
	</tr>
	<tr>
		<td><BR>F</td>
