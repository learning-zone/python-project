...
<br>
<div align='center'>
<a href="javascript:OpenWind2('sendmails.php?class=<?=$class?>&course=<?=$branch?>&sem=<?=$sem?>&examid=<?=$examname_m?>&masteexamn=<?=$masteexamn?>&unit=<?=$unit?>')">
	<input type="button" name="mailsss" value="Sendmail"  class='bgbutton'>
