...
function ReloadMe()
{
    document.frm.action="LeavingCertificate.php";
	document.frm.submit();
}
function OpenWind(k)
{
...
?>
	...
	<td>&nbsp;&nbsp;&nbsp;&nbsp;Student Id</td>
		...
		<td  colspan=3><input type="text"  name='app_no' value="" ></td></tr>
...
<tr><td align='center' class='head' colspan='5'>Leaving Certificate</td>
...
<?php
  ...
  $sno=1;
...

	{
		...
		<td align="center">&nbsp;&nbsp;
        <a href="javascript:OpenWind('LeavingCertificate1.php?StudID=<?=$r[id]?>')"><?=$r[student_id]?></a></td>
