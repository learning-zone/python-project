...
$fsibilings=mysql_fetch_row(mysql_query("select f_photo from student_photo where studid='$StudID' and f_photo!='' limit 1"));

$msibilings=mysql_fetch_row(mysql_query("select m_photo from student_photo where studid='$StudID' and m_photo!='' limit 1"));
...
<tr>
    ...
    <tr>
	  ...
	  <td width="110">&nbsp;&nbsp;Date Of Enrolment</td>
       <td align="left"><input type="text" name="bdate" value="<?php if($bdate==""){ $bdate=date("d/m/Y"); } echo $var2[date_of_enrol]?>" readonly>&nbsp;&nbsp;
...
<tr>
   ...
   <td colspan="6" class="submenu"><b>Username & Password</b></td>
	...
	<tr>
		...
		<td><input name='password' type="password" value="<?=$mod2[password]?>" size='15' readonly></td>
