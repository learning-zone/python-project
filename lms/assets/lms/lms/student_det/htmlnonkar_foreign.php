...
<tr><td class='head' align=center colspan=32 nowrap>NAME OF INSTITUTION : VIDYAVARDHAKA COLLEGE OF ENGINEERING, MYSORE </td></tr>
...
<tr><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>G</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td><td class='row3' align='center'>M</td><td class='row3' align='center'>F</td></tr>
...
while($ss=fetcharray($adg))
{
	...
	$wert=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=1 or course_yearsem=2 ) and cetunder!='KAR' and  gender='M'   "));
    $wer=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=1 or course_yearsem=2 ) and cetunder!='KAR' and  gender='F' "));
    $fwert=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=1 or course_yearsem=2 ) and nationality!='6' and  gender='M' "));
    $fwer=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=1 or course_yearsem=2 ) and   gender='F'and nationality!='6' "));
    ...
    $wert1=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=3 or course_yearsem=4 ) and  gender='M' "));
    ...
    $fwert1=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=3 or course_yearsem=4 ) and   gender='M'and nationality!='6' "));
	$fwer1=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=3 or course_yearsem=4 ) and   gender='F'and nationality!='6' "));
	...
	$wert2=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=5 or course_yearsem=6 ) and   gender='F' "));
	...
	$fwert2=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=5 or course_yearsem=6 ) and   gender='M'and nationality!='6' "));
	$fwer2=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=5 or course_yearsem=6 ) and   gender='F'and nationality!='6' "));
	...
	$fwert3=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=7 or course_yearsem=8 ) and   gender='M'and nationality!='6' "));
	$fwer3=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=7 or course_yearsem=8 ) and   gender='F'and nationality!='6' "));
	...
	if($ss[0]==13)
	{
		...
		$fwert4=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=9 or course_yearsem=10 ) and   gender='M'and nationality!='6' "));
		$fwer4=fetcharray(execute("select count(id) from student_m where course_admitted='$ss[course_id]' and (course_yearsem=9 or course_yearsem=10 ) and   gender='F'and nationality!='6' "));
		...
		echo "<td align='right'>0</td><td align='right'>0</td><td align='right'>0</td><td align='right'>0</td><td align='right'>0</td><td align='right'>0</td></tr>";
