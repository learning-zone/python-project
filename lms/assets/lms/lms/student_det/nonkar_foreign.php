<HTML>
<HEAD>
<TITLE>Non-karnataka & Foreign Student Report</TITLE>
<?php
session_start();
include("../db.php");
...
function excelrpt()
{
	...
	document.frm.action="excelnonkar_foreign.php";
	document.frm.submit();
}
function htmlrpt()
{
	...
	document.frm.action="htmlnonkar_foreign.php";
	document.frm.submit();
}
</script>
</HEAD>
...
<tr><td class='head' colspan='2'>COURSE WISE NON-KARNATAKA & FOREIGN STUDENT REPORT : UG Courses</td></tr>
