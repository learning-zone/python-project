...
<table border='0' align='center' width='90%' class='forumline'>
	...
	<tr>
		<td align='center' class='head'><b>ADMISSION FORM </b></td>
	</tr>
</table>
...
<table class='forumline' align='center' width='90%' border='0'>
    ...
    <option value="FN" <?=$z?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FN</option>
            ...
            <td> <select name="fee_type">
			   ...
			   <tr>
            <td align='right' nowrap>Place Of Birth</td>
            <td><input type="text" name="place" value="<?php echo $place?>"></td>
         
            <td nowrap><br>
            &nbsp;Mother Tounge<font color='red'>*</font></td>
...
<tr>
 ...
 <tr>
	...
	<td align='center'><input type="text" name="10_board" value="<?php echo $s10_board?>" ></td>
...
<td align='center'><input type="text" name="quc_m" value="<?php echo $quc_m ?>"></td>	
<td align='center'><input type="text" name="quc_f" value="<?php echo $quc_f ?>"></td>		
<td align='center'><input type="text" name="quc_g" value="<?php echo $quc_g ?>"></td>			
		</tr>
</table>
<br>
<table border='0' align='center' width='90%' class='forumline'>
...
<table border='0' align='center' width='90%' class='forumline'>
	...
	<td align="center"><input type="text" name="phy_max" value="<?php echo $phy_max?>"  size="10" onChange="getMark()"></td>
		...
		<td align="center">
			<input type="text" name="12_perc" value="<?php echo $s12_perc?>"  size="10" onChange="getMark()"><!-- total marks -->
		</td>
		<td align="center">
