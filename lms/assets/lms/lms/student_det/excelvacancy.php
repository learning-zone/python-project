...
header("Content-disposition: attachment; filename=VACANCY.xls");
?>
...
$sql3=mysql_query("select count(id) from student_m where course_admitted='$row[course_id]' and admission_type='$AdmName' and academic_year='$acayr' and course_yearsem=1");
$stintakedet=mysql_fetch_row($sql3);
echo "<tr><td>$counttemp</td>
