...
<div class="tabContainer">
  ...
  <table class="forumline"  align="center" width="100%">
	...
	<tr><td valign="top"><BR>    
    <li class="currentBtn"><a href="SearchStudent.php?StudID=<?=$StudID?>" title="Student Details">Student</a></li>
...
<tr>
   ...
   if($staffrigtss[0]!='adminm' || $staffrigtss[0]!='admin' || $staffrigtss[0]!='ADMISSION')
	{
