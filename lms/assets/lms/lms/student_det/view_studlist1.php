...
else
{
	if($secid !='a')
		...
		$sql1=execute("select distinct(a.course_yearsem),b.year_name from student_m a,course_year b where a.course_yearsem=b.year_id and a.admission_type='$secid' order by a.course_yearsem ");
...

{
	...
	if($secid !='a')
		...
		$sql2=execute("select id , name from admission where id='$secid'");

	else

		$sql2=execute("select distinct(a.admission_type) , b.name from student_m a, admission b where a.course_yearsem='$r1[0]' and a.admission_type=b.id order by a.admission_type");
...

	{
		...
		echo "<tr height='30'><td class='rowpic' colspan='4'>&nbsp;&nbsp;&nbsp;Class : $r1[1]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admission Type : $r2[1]</td></tr>";
...

		{
...

			{
				...
				$sql.=" and course_yearsem='$r1[0]' and admission_type='$r2[0]' and gender!='F' order by first_name";
