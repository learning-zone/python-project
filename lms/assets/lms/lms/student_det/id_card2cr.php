...
<tr height="40">
<?php
$dstuds=mysql_fetch_row(mysql_query("select s_name,s_photo,new_id from student_photo_other where studid='$id'  and id='$other_id'"));
$fullnamess=mysql_fetch_row(mysql_query("select first_name,last_name,student_id from student_m where id='$id'"));

$stafffsid=mysql_fetch_row(mysql_query("select m_id from additional_info2 where student_id='$id'"));

	$name=$fullnamess[2];
	$var=substr($name,1);
	$mids="G".$var;
?>
<td align="left" style="font-size:17px" colspan="4"  background="red.PNG"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FFFFFF"><?=$dstuds[0]?></font></b></td>
...
<img src="<?php echo $dstuds[1]?>" height="138">
</td>
</tr>
</table>
</td>
<td align="left" width="70px" style="border-bottom-right-radius:20px" background="red.PNG" class="ftsize" ><font color="#FFFFFF">&nbsp;<strong><?=$mids?></strong></font></td>
<td>&nbsp;</td>
<td align="center" colspan="3" nowrap><font color="#D52D12" size="3" style="font-family:'Arial Black', Gadget, sans-serif"><strong>CARE GIVER</strong></font></td>
</tr>
