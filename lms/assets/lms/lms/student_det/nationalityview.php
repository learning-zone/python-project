...
else
{
	...
	if($secid !='a')
		...
		$sql1=execute("select distinct(a.course_yearsem),b.year_name from student_m a,course_year b where a.course_yearsem=b.year_id and a.nationality='$secid' order by a.course_yearsem ");
...

{
	...
	if($secid !='a')
		...
		$sql2=execute("SELECT id , nation FROM nationality where id='$secid'");

	else

		$sql2=execute("select distinct(a.nationality) , b.name from student_m a, nationality b where a.course_yearsem='$r1[0]' and a.nationality=b.id order by a.nationality");
...

	{
		...
		echo "<tr height='30'><td class='rowpic' colspan='4'>&nbsp;&nbsp;&nbsp;Class : $r1[1]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nationality : $r2[1]</td></tr>";
...

		{
...

			{
				...
				$sql.=" and course_yearsem='$r1[0]' and nationality='$r2[0]' and gender!='F' order by first_name";
