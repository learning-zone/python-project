...
$bransql="select year_id, year_name from course_year where ";
    ...
    <tr>
    <td class="head" align='center' colspan="4">Sex Wise Report </td>
    </tr><tr>
    <td class="rowpic" align='center'>&nbsp;Class</td>
    <td class="rowpic" align='center'>&nbsp;Male</td>
    <td class="rowpic" align='center'>&nbsp;Fmale</td>
  ...
  <?php
	...
	{
		$sql3=mysql_query("select count(id) from student_m where gender='M' and course_yearsem='$row1[year_id]'");
		$male=mysql_fetch_row($sql3);
		$sql4=mysql_query("select count(id) from student_m where gender='F'  and course_yearsem='$row1[year_id]'");
