...
$dstuds=mysql_fetch_row(mysql_query("select g_name,parent_username from student_m where id='$id'"));
$dgrdes=mysql_fetch_row(mysql_query("select g_photo from student_photo where studid='$id'"));
...
<td>&nbsp;</td>
<td align="center" colspan="3"><font color="#007236" size="3" style="font-family:'Arial Black', Gadget, sans-serif"><strong>GUARDIAN</strong></font></td>
</tr>
