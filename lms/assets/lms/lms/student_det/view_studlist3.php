...

{
	...
	if($secid !='a')
		...
		$sql1=execute("select distinct(a.course_yearsem),b.year_name from student_m a,course_year b where a.course_yearsem=b.year_id and a.religion='$secid' order by a.course_yearsem ");
...
while($r1=fetcharray($sql1))
{
	if($secid !='a')
		...
		$sql2=execute("select id , name from religion where id='$secid'");

	else

		$sql2=execute("select distinct(a.religion) , b.name from student_m a, religion b where a.course_yearsem='$r1[0]' and a.religion=b.id order by a.religion");
...

	{
		...
		echo "<tr height='30'><td class='rowpic' colspan='4'>&nbsp;&nbsp;&nbsp;Class : $r1[1]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Religion : $r2[1]</td></tr>";
...

		{
...

			{
				...
				$sql.=" and course_yearsem='$r1[0]' and religion='$r2[0]' and gender!='F' order by first_name";
