...
function gen_excel()
{
	document.frm.action='ex_viewstudent_det1.php';
	document.frm.submit();
}
</script>
</HEAD>
...
<table  ALIGN='center' width="70%" cellspacing="2" cellpadding="2"  class="forumline" border="0">
	<tr>
	   <td colspan='5' align='center' class='head'>STUDENTS LIST </td>
	</tr>
	<tr height='25'>
		<td colspan='4'><font color='blue' size='2'><b>&nbsp;Curriculam : <?php echo $new_branch ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;class : <?php echo $new_sem ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Section : <?php echo $new_section ?></td>
	</tr>
	<tr height='15'>
	   <td align='center'><font size='2'>Sl. No.</td>
	   <td align='center'><font size='2'>Student-ID</td>
	   <td align='center'><font size='2'>Name</td>
	 </tr>
	<?php
	$var = "select student_id, usn, first_name,last_name from student_m where course_admitted='$branch' and course_yearsem='$sem' and archive='N' ";
	if($section!='-1')
	{
    ...
    for($i=1;$i<=$num;$i++)
		{
			...
			<tr height='25'>
				...
				<td align='center'><?php if($row[usn]!="") echo $row[usn]; else echo $row[student_id]; ?></td>
...
<div id='pr1' align='center'>
	<INPUT TYPE="button" NAME="print" class='bgbutton' VALUE="PRINT" OnClick="prn()">
	<INPUT TYPE="button" NAME="Excel" class='bgbutton' VALUE="EXPORT TO EXCEL" OnClick="gen_excel()">
</div>
</form>
</BODY>
</HTML>	