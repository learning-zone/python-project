...
$kumar3="select count(id) as adm from student_m where course_admitted='$branch' and academic_year='$a_year' and admission_type='5'";
...
$nam = "select id,first_name,last_name,dob,cetcategory,cor_state,cetrank,cetno,admission_date,cetreceiptno,cetfee,img_source_s from student_m  where course_admitted='$branch'  and academic_year='$a_year' and admission_type='5s' ";
...
for($i=0;$i<$name1;$i++)
 {
  ...
  <?php							
	...
	{
		echo "<tr height=50 >";
		echo " <td colspan=15 align='center'><font color=red>No Records Found In $branch1[coursename] under Diploma quota</font></td></tr>";
	}
