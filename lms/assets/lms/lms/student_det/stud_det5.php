...
$kumar3="select count(id) as adm from student_m where course_admitted='$branch' and academic_year='$a_year' and admission_type='3'";
...
<table border=0 width="150%" cellspacing=0 cellpadding=0 >
 <tr>
 <td align=center  ><font size=4><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APPROVAL LIST <?php echo $sem1[year_name] ?></b></font></td><td align=right colspan=6> ANNEXURE-II</td>
 </tr>
<tr>
<td align=left ><b>ACADEMIC YEAR <?php echo $a_year?>-<?php echo $a_year+1?></b></td>
   <td align=right colspan=6>CATEGORY: <b>GOVT. SEATS</b></td>
 </tr>
<tr>
   <td align=left colspan=6><br><b>Name of the College:  VIDYAVARDHAKA COLLEGE OF ENGINEERING, MYSORE 
   <br><br>
...
$nam = "select id,first_name,last_name,dob,cetcategory,cor_state,cetrank,cetno,admission_date,cetreceiptno,cetfee,img_source_s from student_m  where course_admitted='$branch'  and academic_year='$a_year' and admission_type='3' ";
