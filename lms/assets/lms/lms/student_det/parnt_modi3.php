...
{
				$uptgrdfs="update student_m set img_source_s='$std_email' ,";
...
$sql.="f_quali='$fqul',m_quali='$mqul',sms_mobile='$fmb',";

$sql.="m_occ='$moccup',";

echo $sql.="mother_tongue='$mother',msgphone='$msgphone',rgmailid='$rgmailid',usn='$usn' where id='$stfnameone[0]'";
...
if($nallsv[0])
{
	...
	$query34=mysql_query("UPDATE `additional_info2` SET `passport_no`='$passport_no',`country_of_issue`='$country_of_issue',`type1`='$type1',`type2`='$type2',`type3`='$type3',`type4`='$type4',`emergency_name`='$emergency_name',`emergency_address`='$emergency_address', `date_of_enrol`='$dateabc',`fciti`='$fciti',

`mciti`='$mciti',`gciti`='$gciti',`caregiver_username`='$caregiver_username',

`caregiver_password`='$caregiver_password',`other_address`='$other_address',`f_id`='$f_id',`m_id`='$m_id',`g_id`='$g_id',`mother_tongue_2`='$mother_tongue_2',`nationality2`='$nationality2',`emergency_number`='$emergency_number',`emergency_mail`='$emergency_mail' WHERE student_id='$stfnameal[0]'");
...
{ 
	 ...
	 $query78=mysql_query("INSERT INTO `additional_info2`(`passport_no`, `fciti`,  `mciti`,`gciti`,`country_of_issue`) VALUES('$passport_no', '$fciti',  '$mciti','$country_of_issue'");
...
{ 
	 ...
	 $query=mysql_query("INSERT INTO `additional_info2`(`passport_no`, `fciti`,  `mciti`,`gciti`,`country_of_issue`) VALUES('$passport_no', '$fciti',  '$mciti','$country_of_issue'");
...
<b><a href="view_stud3.php?StudID=<?php echo $StudID ?>">Back</a></b></font></td></tr>
