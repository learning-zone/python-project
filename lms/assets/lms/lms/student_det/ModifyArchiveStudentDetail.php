...
{
	document.frm.action="ViewArchiveReport1.php";
	document.frm.submit();
}
...
<tr><td align='center' class='head'><b>MODIFY ADMISSION FORM</b></td></tr>
...
<tr><td><font color="blue" size="2" colspan='4'><u>Admission details :</u></font></td></tr>
...
<tr><td>
 <table border='0' align='center' width='100%' class='forumline'>
    <tr height="25"> 
      <td colspan=6><font color="blue" size="2"><u>Student Details :</u></font></td>
    </tr>
	<tr height="25">
    <td nowrap>&nbsp;&nbsp;Student Name </font></td>
    <td><?php
	echo "<input type='hidden' name='fname' value='$mod2[first_name]'>";
	 echo $mod2[first_name]?></td>
...
<td  align='center' colspan=1><font size="2" color="#CC0000">Father Details</font></td>
<td align='center' colspan=1><font size="2" color="#CC0000">Mother Details</font></td>
<td align='center' colspan=1><font size="2" color="#CC0000">Gaurdian Details</font>
 ...
 <tr>
    ...
    <tr>
	<td>&nbsp;&nbsp;Occupation</td>
	<td align='center'><?php echo $mod2[parent_occupation]?></td>
	</td><td align='center'><?php echo $mod2[m_occ] ?></td>
	<td align='center'><?php echo $mod2[g_occ]?></td>
</tr>
<tr>
	<td>&nbsp;&nbsp;Annual Income</td>
	<td align='center'><?php echo $mod2[parent_income]?></td>
	<td align='center'><?php echo $mod2[m_inc]?></td>
	<td align='center'><?php echo $mod2[g_in]?></td>
 </tr>
 <tr>
	<td>&nbsp;&nbsp;Mobile Number</td>
 ...
 <tr>
	...
	<td align='center'><?php echo $mod2[g_email]?></td>
 </tr>
 <tr>
...
<td align='center'><?php echo $mod2[goadd] ?></td>			
		</tr>
</table></td></tr>
<tr><td>
<table border='0' align='center' width='100%' class='forumline'>
	<tr height="25">
		<td width='50%'><font color="blue" size="2"><u>Present Address :</u></font></td>
		<td width='50%'><font color="blue" size="2"><u>Permanent Address :</u></font><br>
			</tr>
    <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id='prn' align='center'>
  <input class='bgbutton' type="button" value="Activate" name="print" onClick="printReport()" >
</div>
