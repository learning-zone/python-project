...
<?php
  ...
  $sno=1;
...

	{
        ...
        <a href="view_Apl.php?StudID=<?php echo $r[id]?>&app_num=<?php echo $app_num ?>&branch=<?php echo $branch ?>&sem=<?php echo $sem ?>&studfname=<?php echo $studfname ?>&a_year=<?php echo $a_year ?>&un=<?php echo $un ?>"><?=$r[student_id]?></a></td>
