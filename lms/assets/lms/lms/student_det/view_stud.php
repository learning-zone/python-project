...
$vatnames=fetcharray(execute("select id from student_m where username='$user'"));
...
function F876()
{
    ...
    function reload1() {
        document.frm.action = "view_stud.php";
        document.frm.submit();
    }
...
<script>
    $(document).ready(function(){
        ...
        $(".iframe").lightbox({iframe:true, width:"90%", height:"90%"});                                
...
<script>
    $(document).ready(function(){
        //Assign the lightbox event to elements
        $(".iframe1").lightbox({iframe:true, width:"70%", height:"70%"});                                
        //Preserving a JavaScript event for inline calls.
        $("#click").click(function(){ 
            $('#click').css({"background-color":"#f00", "color":"#fff", "cursor":"inherit"}).text("Open this window again and this message will still be here.");
            return false;
...
<body>
<form name='frm' method='post' ENCTYPE='multipart/form-data' action="parnt_modi.php">
...
<input type='hidden' name='image' value='<?php echo $mod2[img_source] ?>'>
            ...
            <table align='center' width='98%' class='forumline' border='2'>

                <tr>
                    <td align='center' class='head'>STUDENT DETAILS</td>
                </tr>

                <tr height="25">
                    <td class="submenu" colspan="4" nowrap>
                    <div id=123A style="float: left; text-align: left;">
                        <b>Admission details </b>
                    </div>
                    <div id=123B style="float: right; text-align: right;">

                        <!--<a href="javascript:OpenWind3('student_medical_info_p.php?student_id=<?=$StudID?>')" >--> <!--<input type="hidden" name="store_stud" value="<?=$store_stud?>">-->
                         <a class='iframe' href="student_medical_info_p.php?student_id=<?=$StudID?>">
                ...
                <tr>
                    ...
                    <table width='98%' border='0' align='center'>
                        ...
                        <tr height="25">
                            ...
                            <td>
                            <input name="appl_num" type="text" value="<?php echo $mod2[id] ?>" size="34" readonly>
                            </td>
...
<tr><td width="100%">
 ...
 <table border='0' align='center' width='100%' class='forumline'>
    ...
    <td><input type="text" name="fname" value="<? echo $mod2[first_name]?>" size=30 disabled></td>
      ...
      <td>&nbsp;&nbsp;&nbsp;&nbsp;Last Name *</td>
		...
		<td><input type="text" name="lname" value="<? echo $mod2[last_name]?>" size=30 disabled></td>
...
<td nowrap>&nbsp;&nbsp;Mother Tongue 2</td>    <td><select name="mother_tongue_2" ><option>-----Select------</option>
	...
	<tr height='25'>
	 ...
	 <td colspan="3"><input type="text" name="std_email" onChange="validateForm(this.name)"  value="<?=$mod2[img_source_s]?>" size='30'></td> 
...
<table border='0' align='center' width='98%' class='forumline'>
...
<table class='forumline' align='center' width='98%' border="0">
...
<tr>
   ...
   <td height="25">&nbsp;&nbsp;Upload Documents</td>
	 ...
	 <td><input size="20" name="uploadedPassport[]" id='uploadedPassport' type="file"  multiple />

	 &nbsp;&nbsp;&nbsp;&nbsp;

     <a class='iframe1' href="student_doc.php?student_id=<?=$StudID?>&type=doc_edt">Modify Documents</a><font color="#FF6600"> (Upload Photograph Page Of Student Passport)</font>
      </td>
...
<div align='center'>
    ...
    <input type="button" class="bgbutton" value="Print"  onclick="F876()">
