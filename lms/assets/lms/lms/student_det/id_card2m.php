...
$dstuds=mysql_fetch_row(mysql_query("select m_name,parent_username from student_m where id='$id'"));
$dgrdes=mysql_fetch_row(mysql_query("select m_photo from student_photo where studid='$id'"));
