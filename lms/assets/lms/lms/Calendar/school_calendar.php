...

{
...

	{
...

		{
			...
			$sql="insert into announcement_call (`type`, `fromdate`, `todate`, `title`, `description`, `division`, `grade`, `status`) values ('$type', '$fdate', '$tdate', '$ename', '$descr', '$branch', '$value',1)";
...
<?php
...

	{
		...
		//execute("insert into school_calendar (type,fromdate,todate,title,description,division,grade) values('$type','$fdate','$tdate','$ename','$descr','$branch','$sem')");
...

{
    ...
    <tr >
		...
		<td>&nbsp;&nbsp;<select name="branch" onChange="go()">
			...
			<option value="0">------All-----</option>
				...
				<?php
					...
					$sql="select course_id,coursename from course_m where head_id='$schoolid'";
		...
		<td>&nbsp;&nbsp;<select name="sem[]" multiple>

			<!-- <option value='0'>--SELECT--</option> -->

			<?php

				$rs=execute("SELECT year_name, year_id FROM course_year where head_id='$branch'");
