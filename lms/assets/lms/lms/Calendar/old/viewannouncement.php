...
$sql1=mysql_query("SELECT id FROM `announcement` where ('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
while($r1=mysql_fetch_array($sql1))
{
	$sql2=mysql_query("SELECT * FROM `announcement` where id='$r1[id]'");
