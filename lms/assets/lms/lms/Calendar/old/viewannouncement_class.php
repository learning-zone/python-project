...
<tr height="30">
	   ...
	   Announcement On <?php echo $adate;?> </td>
</tr>
<?php
$i=1;
...
$sql1=mysql_query("SELECT id FROM `announcement_class` where class='$sem' and ('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
while($r1=mysql_fetch_array($sql1))
{
	$sql2=mysql_query("SELECT * FROM `announcement_class` where id='$r1[id]'");
