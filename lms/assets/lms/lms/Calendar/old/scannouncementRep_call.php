							   ...
							   if($das[0]=='Sun')
							   {
										...
										if($todayDate==$bdate)
								   			$newbgcolor='class="headc"';
								   		 	...
								   		 	$newbgcolor='';
												$sql3=mysql_query("SELECT id  FROM `announcement_call` where ('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
								...
								if($avail=="Yes")
								{
								$getcountappointments=mysql_query("SELECT count(id) FROM `announcement_call` where ('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
