...

{
  ...
  document.frm.action='class_call_rep.php';
...
<tr height="30">
	   ...
	   <td colSpan="7" align="center" class='head'><strong>Class Calendar</strong></td>
...

						{
...

							   {
										...
										if($todayDate==$bdate)
								   			...
								   			$newbgcolor='class="headc"';
												...
												$sql3=execute("SELECT id  FROM $newquery('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
								   ...
								   ?>
									...
									<a href="javascript:void(0)" onClick="window.open('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>','editservices', 'resizable=yes, scrollbars=yes, height=400, width=600'); return false"><font color="#FF0000"><?php echo $i?>
								...
								$getcountappointments=execute("SELECT count(id) FROM $newquery('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
...

							   {
								   ...
								   ?>
									...
									<a href="javascript:void(0)" onClick="window.open('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>','editservices', 'resizable=yes, scrollbars=yes, height=400, width=600'); return false"><?php echo $i?></a> 
							 ...
							 if($das[0]=='Fri')
...

							   {
								   ...
								   ?>
									...
									<a href="javascript:void(0)" onClick="window.open('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>','editservices', 'resizable=yes, scrollbars=yes, height=400, width=600'); return false"><?php echo $i?></a> </div> </b>
...

						   {
							   ...
							   ?>
								...
								<a href="javascript:void(0)" onClick="window.open('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>','editservices', 'resizable=yes, scrollbars=yes, height=400, width=600'); return false"><font color="<?php echo $bgcolor; ?>"><?php echo $i?></font></a></div>
