				       ...
				       for($i=1;$i<=$r;$i++)
				       {
							...
							if($i==1 )
						   {
							   if($das[0]=='Sun')
							   {
								   ...
								   ?>
									...
									<div Align="center" >
                                    <a href="javascript:void(0);" onClick ="OpenWind2('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>', 'OpenWind2',700,400)"><font color="#FF0000"><?php echo $i?></font></a>
									 									
									<?php
								if($avail=="Yes")
								{
								$getcountappointments=execute("SELECT count(id), title FROM $newquery('$bdate' between fromdate and todate and type=2) or (type=1 and fromdate='$bdate')");
							   ...
							   if($das[0]=='Mon')
							   {
								   ...
								   ?>
                                    ...
                                    <a href="javascript:void(0);" onClick ="OpenWind2('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>', 'OpenWind2',700,400)"><?php echo $i?></a>
						   ...
						   else
						   {
                            ...
                            <font color="<?php echo $bgcolor; ?>">	
                               ...
                               <a href="javascript:void(0);" onClick ="OpenWind2('class_call_rep_print.php?mon=<?php echo $mont?>&yer=<?php echo $yr?>&day=<?php echo $i?>', 'OpenWind2',700,400)"><font color="<?php echo $bgcolor; ?>"><?php echo $i?></font></a>
