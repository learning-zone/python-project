...
<tr>
	...
	{      
	   ...
	   $ans=fetchrow(execute("select Description from `online_exam_des_mark` where exam_id='$idn' AND student_id='$student_id' and status='1' AND ques_id='$r6[0]' ORDER BY ques_id"));
