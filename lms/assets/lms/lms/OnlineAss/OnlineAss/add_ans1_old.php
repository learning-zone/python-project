...
if(isset($_POST['update']))
{
	...
	for($i=0;$i<sizeof($cid);$i++)
	{
		...
		if($optionval!='')
		{
			...
			$mark=0;
			mysql_query("INSERT INTO `online_exam_sel_mark` (`exam_id`, `ans`, `student_id`, `status`,score) VALUES ('$idn', '$optionval', '$student_id', '1','$mark');") or die(mysql_error());
...
<tr>
	...
	{
			$sql21=mysql_query("select score from online_exam_sel_mark where exam_id='$r6[0]' and status='1'");
			$k=1;
