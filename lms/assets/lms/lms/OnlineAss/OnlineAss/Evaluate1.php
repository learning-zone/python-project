...
if(isset($_POST['update']))
{
	...
	for($i=0;$i<sizeof($cid);$i++)
	{
		...
		mysql_query("update online_exam_sel_mark set  score='$score' where id='$cid[$i]'");	
	}
		?>
...
<?php
$sql31=mysql_query("SELECT student_id FROM `online_exam_sel_mark` where exam_id='$idn' and status=1 group by student_id");
