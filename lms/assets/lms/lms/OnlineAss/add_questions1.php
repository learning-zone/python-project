...
if(isset($_POST['update']))
{
	...
	for($i=0;$i<sizeof($cid);$i++)
	{
		...
		execute("update online_exam_des_questions set Description='$Questions', score='$score' where id='$cid[$i]'");	
	}
		?>
...
if(isset($_POST['save']))
{
	...
	{
		$sql2=execute("select * from online_exam_des_questions where exam_id='$idn' and Description='$Questions' and status='1'");
		if(rowcount($sql2)>=1)
		{
			?>
			<Script language="JavaScript">
		...
		else
		{
			...
			execute("INSERT INTO `online_exam_des_questions` (`exam_id`, `Description`, `score`, `status`) VALUES ('$idn', '$Questions', '$score', '1');") or die(mysql_error());
			?>
			<Script language="JavaScript">
