...
<tr><td>&nbsp;&nbsp;User</td><td>
<?
//echo "SELECT a.username, b.f_name, b.s_name FROM users a, staff_det b WHERE a.Activated='On' and a.username!='administrator' and b.slno=a.S_ID order by a.username";
?>
...
<?php
	$sql1=execute("select * from subjecttype");
