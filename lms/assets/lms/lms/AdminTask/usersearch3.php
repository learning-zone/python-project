...
function winclose(Code, username1)
{
	...
	self.opener.document.MyFrm.action = "DeleteRightsofStaff.php";
	window.close();
}
</SCRIPT>
</HEAD>
<BODY CLASS="bodyline">
<FORM NAME="searchfrm" METHOD="POST" ACTION="usersearch3.php">
...
<FORM name="frmtemp" action="usersearch3.php" mehtod="POST">
