...
//echo "select count(avg_grade) from dp_remark where exam_id='$examid' and sub='$subject' group by avg_grade order by avg_grade";
  ///////////grade end/////////////
 ?>
...
<tr>
    <td  align='center' style="font-size:20px" nowrap><b>Performance Reports for DP FORUM</b></td>
</tr>
</table>
...
<tr>
    <td class="rowpic" colspan="5" style="border:1px solid black;" bgcolor="#999999"><b>&nbsp;&nbsp;CLASS TESTS CONDUCTED</b></td>
</tr>
<tr>
<td style="border:1px solid black;">&nbsp;&nbsp;CLASS TEST</td>
...
{
?>
        <td align="left" style="border:1px solid black;" width="10%" nowrap>&nbsp;&nbsp;Class Test <?=$i?> </td>
...
?>
 ...
 ?>
 <?
 $asobj=fetchrow(execute("select asob from dp_remark where student_id='$studentid' and exam_id='$examid' and sub='$subject'"));
 ?>  
</tr>
<tr>
...
<tr>
<td align='left' colspan='10' style="border:1px solid black;"><?php echo $sug; ?></td>
</tr>
<tr height="30">
...
<?
$gradone=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=1 and sub='$subject' group by avg_grade order by avg_grade"));

$gradtwo=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=2 and sub='$subject' group by avg_grade order by avg_grade"));

$gradthre=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=3 and sub='$subject' group by avg_grade order by avg_grade"));

$gradfour=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=4 and sub='$subject' group by avg_grade order by avg_grade"));

$gradfive=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=5 and sub='$subject' group by avg_grade order by avg_grade"));

$gradsix=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=6 and sub='$subject' group by avg_grade order by avg_grade"));

$gradseven=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=7 and sub='$subject' group by avg_grade order by avg_grade"));

?>
<tr>
    <td class="rowpic" colspan="8" style="border:1px solid black;" bgcolor="#999999"><b>&nbsp;&nbsp;CLASS-WISE GRADES STATUS&nbsp;:&nbsp;</b></td>
</tr>
 <tr>
...
<tr>
	<td align='left' class="row2" colspan="10" style="border:1px solid black;" bgcolor="#999999"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;Lerner Profiles&nbsp;-&nbsp;Your ward has shown the qualities of a</div></td></tr>
    </table>
<table align="center" width="90%" cellspacing="0" cellpadding="3" style="border:1px solid black;">
<tr>
  <?
...
$prantname=fetcharray($prant);
  ?>
  <tr>
    <td  align="left"><strong>Facilitator - B & M</strong></td>
...
<?
$p=1;
$assessment=execute("select criteria from dpcriteria where class='$sem' and sub='$subject' and exam_id='$examid'");
