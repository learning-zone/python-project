...
//$gradenam=fetcharray(execute("select avg_grade,count(avg_grade) from dp_remark where exam_id='$examid' and avg_grade=5 and sub='$subject' group by avg_grade order by avg_grade"));
  ///////////grade end/////////////
 ?>
...
$Sql67=execute("select suggestion,submission,expect,asob from dp_remark where student_id='$studentid' and exam_id='$examid' and sub='$subject'");
