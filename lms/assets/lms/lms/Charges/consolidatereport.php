...
function send()
{
	...
	document.frm.action='studentconsolidate.php';
	document.frm.submit();
}
function frm_reload()
{
	document.frm.action='consolidatereport.php';
	document.frm.submit();
} 
</script>
</head>
...
<table class='forumline' align='center' width='60%'><tr>
<td Class="Head" id="Head" colspan='5' align='center'>Search Student Details</td></tr>
...
<td>&nbsp;&nbsp;Curriculam</td>
	...
	<td>&nbsp;&nbsp;Student Name</td>
	<td align='center'><input type='text' name='studfname' value=""></td></tr>
</table><br>
<div align='center'>
