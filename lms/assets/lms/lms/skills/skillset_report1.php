...
$totalcalss=fetchrow(execute("select count(id) from $att_table where ( att_date between '$f_date' and '$t_date') group by att_date"));

$present=fetchrow(execute("select count(id) from $att_table where ( att_date between '$f_date' and '$t_date') and stu_id='$studentid' and mor='1'"));
	
$absent=fetchrow(execute("select count(id) from $att_table where ( att_date between '$f_date' and '$t_date') and stu_id='$studentid' and ( mor='0' )"));
