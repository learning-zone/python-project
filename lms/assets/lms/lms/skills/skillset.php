...

{
	...
	document.frm.action='skillset.php';
...
?>
  ...
  echo "<tr height='25'>
    ...
    <td nowrap align='center'>&nbsp;<a href= "javascript:OpenWind2('addskill.php?course=<?=$branch?>&sem=<?=$sem?>&examid=<?=$examname?>&studentid=<?=$r1[id]?>&class_section_id=<?=$class_section_id?>&stundetname=<?=$r1[first_name]?>&student_id=<?=$r1[student_id]?>')">ADD MARKS		
