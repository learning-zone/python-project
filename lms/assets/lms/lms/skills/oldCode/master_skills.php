...
if(isset($_POST['update']))
{
	...
	for($i=0;$i<sizeof($cid);$i++)
	{
        ...
        mysql_query("update master_skills set skill='".addslashes($skills)."', mark='$mark', posi='$priority' where id='$cid[$i]'");	
	}
		?>
		<Script language="JavaScript">
...
if(isset($_POST['save']))
{
	...
	if($skills!='')
{
	$sql2=mysql_query("select * from master_skills where divi='$course' and class='$sem' and sub='$subject' and skill='$skills' and posi='$priority' and exam_id='$examname_m'");
...
$sql3=mysql_query("select id, skill, posi,mark from master_skills where divi='$course' and class='$sem' and sub='$subject' and exam_id='$examname_m'");
