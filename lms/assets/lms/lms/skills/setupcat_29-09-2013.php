   ...
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++			
	  ...
	  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        <?
			...
			if($_POST[subject]!='' and $_POST[category]!='' and $_POST[term]!=''){
				
					$tablename='grade_m_'.$subject.'_'.$term;
					
					//echo "<br>UPDATE `$tablename` SET `avg_$category` = '$avg' WHERE `student_id`= $r[id]";
										
					$sqlUd="UPDATE `$tablename` SET `avg_$category` = '$avg' WHERE `student_id`= $r[id]";
					
					$resultUd=execute($sqlUd) or die(mysql_error()."Error first !!!".$tablename);
					//$resultUd=execute($sqlUd);
			}
			++$count;
			++$sno;
			 ++$i;
