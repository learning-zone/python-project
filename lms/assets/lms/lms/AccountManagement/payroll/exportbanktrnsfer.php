...
header("Content-Disposition: attachment; filename=banktransfer.doc");
...
?>
		  <tr >
              ...
              <div align="center" class="style6 style4 style5"><b>BANK TRANSFER FOR THE MONTH <?php echo $m."-".$year;?></div>              <p class="style6 style4">&nbsp;</p>
              <p class="style7 style5 style4"><strong>DEPARTMENT:<?php echo $dep[0];?></strong></p></td>
            </tr>
			 <tr>
			  <td colspan=3><div align=center >_______________________________________________________________________________________________________________________________</div></td></tr>
            <tr >
              <td  id="TH"><b>A/C NO: </td>
              <td ><b>NAME</td>
              <td  ><b>AMOUNT</td>
            </tr>
			<tr>
			...
			?>
            <tr>
              <td><?php echo $r1[vaccount];?></td>
              <td><?php echo $r1[vemp_name];?></td>
              <td><?php echo $r2[fnetsal];?></td>
            </tr>
			<?php
				$s1=$s1+$r2[fnetsal];
			}
