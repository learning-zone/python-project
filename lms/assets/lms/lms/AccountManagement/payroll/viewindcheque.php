	 ...
	 include("padminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          ...
          <form id="form1" method="post" action="viewindcheque.php">
		...
		?>
              ...
              <input name="button" type='button' onclick='javascript:window.location.href=&quot;exportchequestmt.php&quot;' value='Export' /></td>
            </tr>
          </table>
          ...
          <table width="101%" height="103" border="1"  bordercolor="#000000" bgcolor="#FFFFFF" cellspacing="0">
		   <tr >
              <td height="65" colspan="17"><div align="center" class="style5 style4"><span class="style3"><strong>BANGALORE SCHOOL<br />
              SARJAPUR MAIN ROAD,KORAMANGALA,BANGALORE-34</strong></span></div>
              <p class="style6 style4 style8">&nbsp;</p>
              <div align="center" class="style6 style4 style8">INDIVIDUAL CHEQUE STATEMENT FOR THE MONTH <?php echo $m."-".$year;?></div>              <p class="style6 style4">&nbsp;</p>
            ...
            <?php
			$s1=0;
			$qry1=mysql_query("select * from emp_salary where  vmonth='$month' and iyear='$year'  and iIdx_department='$dept' and ptype='cheque'");
