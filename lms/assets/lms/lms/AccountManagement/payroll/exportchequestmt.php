...
?>
		  <tr >
              ...
              <div align="center" class="style6 style4 style5"><b>INDIVIDUAL CHEQUE STATEMENT FOR THE MONTH <?php echo $m."-".$year;?></div>              <p class="style6 style4">&nbsp;</p>
			...
			$qry1=mysql_query("select * from emp_salary where vId_emp='$r1[vemp_id]' and vmonth='$month' and iyear='$year'  and ptype='cheque'");
