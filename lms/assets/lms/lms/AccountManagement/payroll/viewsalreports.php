	 ...
	 include("padminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          ...
          <table width="850" border="1" style="position:absolute; left: 214px; top: 239px;" bordercolor="#000000" bgcolor="#FFFFFF" cellspacing="0" >
		    <tr >
		...
		?>
              ...
              <input name="button" type='button' onclick='javascript:window.location.href=&quot;exportempwise.php&quot;' value='Export' /></td>
            </tr>
          </table>
