...
{
$ins=$_POST['comboin'];
$qq=mysql_query("select * from ac_institution where iIdx_institution='".$ins."'");
 $obj=mysql_fetch_object($qq);
$ins1=$obj->vinstitution;
}
else
{
$ins=$_SESSION['ins'];
  ...
  <div id="wrapper">
	...
	else
	{
	 include("padminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          <form id="form1" name="form1" method="post" action="addattendanceaction.php" onsubmit="return validate();">
          <table width="823" border="0" align="center" id="tbl" cellspacing="0">
            <tr id="th">
              <th height="26" colspan="6" scope="row">ATTENDANCE</th>
            </tr>
            <tr id="td1">
              <th height="21" colspan="6" scope="row"><div align="center"><?php if($type=='a')echo $ins1;else echo $ins;?><input type="hidden" name="ins1" value="<?php echo $ins;?>" /></div></th>
            </tr>
            <tr id="td1">
	 ...
	 echo date('d-m-Y',strtotime($date));;
	  ?>&nbsp;<input type="hidden" name="atdate" value="<?php echo $date;?>" /></td>
              <td width="37"><div align="center"><strong>Shift&nbsp;</strong></div></td>
              ...
              <td width="113" ><div align="right"><strong><span class="style18"> Department </span></strong></div></td>
              <td width="212" >
			  <?php
			  ...
			  <input type="hidden" name="deptid" value="<?php echo $jtype;?>" />			  </td>
            </tr>
			...
			?>
            <tr id="td1">
              <th width="67" height="22" scope="row"><?php echo $row1[iId_emp];?></th>
              <td width="168"><?php echo $row1[vemp_id];?> <input type="hidden" name="empid" value="<?php echo $row1[vemp_id];?>" /></td>
              ...
              <td>
			 <?php
			 $q4=mysql_query("select * from emp_attendance where att_department='".$jtype."' and att_date='".$date."' and att_empid='".$row1[iId_emp]."' and att_shift='".$shift."'");
			$w4=mysql_fetch_object($q4);
			 ...
			 {
			 ?>
			  <select name="ratt" onchange="saveatt(this.value,<?php echo $row1[iId_emp];?>)"><option value="0">-SELECT-</option><option value="P">Present</option><option value="A">Absent</option></select>
			  <?php
			  }
			  ?>
