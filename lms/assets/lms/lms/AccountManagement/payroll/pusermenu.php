...
<div id="categories">
		...
		<li><a href="home.php">Home</li>
			<?php if($tran==1) { ?><li><a href="../accountingvouchers.php">Transactions</a></li><?php } ?>
		 ...
		 <!--  <li><a href="#">Display</a>
		   ...
		   <?php if($chp==1) { ?><li ><a href="../changepassword.php">Change Password</a>		   </li><?php } ?>
		     <li ><a href="#">Payroll</a>		   
		   <ul>
		   <!-- <?php if($cdep==1) { ?> <li ><a href="adddepartment.php">Institution</a>		   </li><?php } ?>-->
			  <?php if($cjob==1) { ?><li ><a href="adddesignation.php">Jobs</a>		   </li><?php } ?>
			    <?php if($addemp==1) { ?><li ><a href="addemp1.php">Employees</a>		   </li><?php } ?>
				   <?php if($addatt==1) { ?><li ><a href="attendance.php">Attendance</a>		   </li><?php } ?>
				   <?php if($addsal==1) { ?> <li ><a href="salarypayment1.php">Salary</a>		   </li><?php } ?>
		   </ul></li>
