...
header("Content-Disposition: attachment; filename=ledgerbook.doc");
header("Pragma: no-cache");
header("Expires: 0");
echo "<html>";
echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=Windows-1252\">";
echo "<body>";
echo "<b><table border=1 id=tb2>";
...
echo "<b><tr><td>DATE</td><td>VOUCHER NO:</td><td>PARTICULAR</td><td>DEBIT</td><td>CREDIT</td><td>BALANCE</td></tr></b>";
 ...
 echo "<tr>
                <tdcolspan=7><div align=right><strong>To Balance Brought Down=&gt;";
	...
	if($row2[Dr_Cr]=="Cr"){$s=$s+$row2[fcredit]+$b;}if($row2[Dr_Cr]=="Dr"){$s=$s-$row2[fdebit]+$b;}
	 $dtd=date('d-m-Y',strtotime( $row2[ddate]));
	  ...
	  if($row2[Dr_Cr]=="Cr"){
                ...
                echo "<td>$row2[fcredit]</td>"; } else { echo "<td></td>"; } 
