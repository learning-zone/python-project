  ...
  <div id="wrapper">
	...
	include("usermenu.php");
	 ...
	 include("adminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          <form id="form1" name="form1" method="post" action="viewbalancesheet3.php" onsubmit="return validate();">
            <table width="200" border="0" style="position:absolute; left: 390px; top: 169px; width: 385px;">
              <tr>
                <td colspan="3"> <div align="center"  id="hd"><strong>BALANCE SHEET </strong></div></td>
        </tr>
              <tr>
	...
	?> 
	  ...
	  ?></td> 
		...
		if($mon>3)
		{
	  $myCalendar = new tc_calendar("date51", true, false);
	  ...
	  ?>&nbsp;</td>
		...
		if($mon>3)
		{
	  $myCalendar = new tc_calendar("date52", true, false);
	  $myCalendar->setIcon("images1/iconCalendar.gif");
