        ...
        <div class="inner">
          <form id="form1" name="form1" method="post" action="exportprofitloss.php" onsubmit="return validate();">
            <table width="200" border="1" style="position:absolute; left: 216px; top: 111px; width: 702px; height: 114px;" cellspacing="0" bgcolor="#FFFFCC" id="tbl">
              <tr id="th">
                <td colspan="3"><div align="center" class="style3 style5"><strong>INCOME/EXPENSE ACCOUNT </strong></div></td>
              </tr>
              <tr id="td1">
...
//echo $tt;
	  ...
	  <?php
              ...
              <tr>
                      <td height="17" colspan="3"><div align="right"><input name="button" type='button' onclick='javascript:window.location.href=&quot;exportincomeexp.php&quot;' value='Export' /></div> </td>
              </tr>
            </table>
          </form>	
            <h2>&nbsp;</h2>
