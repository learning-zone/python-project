  ...
  <div id="wrapper">
	...
	include("usermenu.php");
	 ...
	 include("adminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          <form id="form1" name="form1" method="post" action="viewbankbook1.php" onsubmit="return validate();">
  <table width="972" border="0" style="position:absolute; left: 329px; top: 158px; width: 397px; height: 89px;">
    <tr>
      <td height="29" colspan="3"><a href="index.html"></a>
        <div align="center" id="hd"><span class="style1 style7 style5">BANK BOOK </span></div></td>
    </tr>
	 <?php
		if($tp=='a')
		{
		?>
    <tr>
      <td width="84" height="29"><div align="right" class="style8 style6">
    ...
    <tr>
      <td height="23"><div align="right" class="style8 style7">
    ...
    <tr>
      <td height="23"><div align="center"><strong>To</strong></div></td>
      <td><?php
		$yr=date('Y');
		$yr1=$yr-1;
		$yr2=$yr+1;
    ...
    <tr>
      <td height="26"><strong>
        <label>
        <div></div><div align="center"><strong>Ledger      </strong></div>
        <strong>
          </label>
          </strong></td>
      <td height="26"> <?php
		if($tp=='a')
		{
		?><div id="txtHint9"><select name="lisled"><option value="select">-SELECT-</option></select></div><?php } else{?>
        <?php
$b="Bank Accounts";
if($mon>3)
		{
...
$i1=$ob1->iIdx_grp;
$qryy1="select * from ac_ledger where iIdx_group=\"$i1\" and iIdx_organization=\"$or1\" and date between '".$y21."' and '".$y32."'";
$result = execute($qryy1);
$r=fetchrow(execute("select * from ac_ledger where iIdx_group=\"$i1\" and iIdx_organization=\"$or1\" and date between '".$y21."' and '".$y32."'"));
}
else
{
$qryy=execute("select * from ac_allgroup where vgroupname=\"$b\"");
$ob1=mysql_fetch_object($qryy);
$i1=$ob1->iIdx_grp;
$qryy1="select * from ac_ledger where iIdx_group=\"$i1\" and iIdx_organization=\"$or1\" and date between '".$y33."' and '".$y11."'";
$result = execute($qryy1);
$r=fetchrow(execute("select * from ac_ledger where iIdx_group=\"$i1\" and iIdx_organization=\"$or1\" and date between '".$y33."' and '".$y11."'"));
}
if($r<=0)
{
...
?>   </td>
    ...
    <tr>
      <td colspan="3"><div align="center"><input name="submit" type="submit" value="   VIEW   " />
        </div></td>
      </tr>
  </table>
  </form>
