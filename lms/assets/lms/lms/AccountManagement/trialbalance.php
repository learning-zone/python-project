  ...
  <div id="wrapper">
	...
	include("usermenu.php");
	 ...
	 include("adminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          <form id="form1" name="form1" method="post" action="vtrialbalance2.php" onsubmit="return validate();">
            <table width="972" border="0" style="position:absolute; left: 426px; top: 161px; width: 394px; height: 186px;" >
    <tr>
      <td height="29" colspan="5"><div align="center" id="hd"><span class="style1 style4 style6"><strong>TRIAL BALANCE </strong></span></div></td>
    </tr>
    <tr>
	...
	<?php
		...
		?>
	  <tr>
      <td width="110" height="29"><div align="right" class="style5">
    ...
    <tr>
      <td height="23"><div align="right" class="style5">
      ...
      <td width="157"><?php
		...
		if($mon>3)
		{
	  $myCalendar = new tc_calendar("date31", true, false);
    ...
    <tr>
      <td><label>
        <div align="left"><span ><strong>To</strong></span>        :</div></td>
      <td><?php
		$yr=date('Y');
		$yr1=$yr-1;
		$yr2=$yr+1;
		...
		if($mon>3)
		{
	  $myCalendar = new tc_calendar("date32", true, false);
	  $myCalendar->setIcon("images1/iconCalendar.gif");
	 // $myCalendar->setDate(date('d'), date('m'), date('Y'));
	  $myCalendar->setPath("./");
	  $myCalendar->setYearInterval($yr3, $yr4);
    ...
    <tr>
      ...
      <td><label>
        <input type="checkbox" name="alphacheck" value="1" />
        <strong>Alphabetical Order</strong></label></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
