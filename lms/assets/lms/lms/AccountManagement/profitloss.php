  ...
  <div id="wrapper">
	...
	include("usermenu.php");
	 ...
	 include("adminmenu.html");
      ...
      <div id="seasonal">
        <div class="inner">
          <form id="form1" name="form1" method="post" action="viewprofitloss3.php" onsubmit="return validate();">
            <table width="200" border="0" style="position:absolute; left: 364px; top: 159px; width: 385px;">
              <tr>
                <td colspan="3"><div align="center" id="hd"><strong>PROFIT AND LOSS ACCOUNT </strong></div></td>
      </tr>
             <tr>
