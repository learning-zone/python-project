...
$sql="update student_m_pre set last_name = '$lname', admission_date='$date123',student_id='$adm_num',first_name='".addslashes($fname)."',nationality='$nat',religion='$rel',img_source_s = '$std_email', usn = '$usn',";
...
$sql.="m_email='$memail',mnum='$mnum',g_name='$gname',g_occ='$goccup',g_in='$ginc',g_num='$gmb',g_mail='$gemail',f_email='$femail',";
