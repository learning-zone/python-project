...
function reload1()
{
	...
	document.frm.action = "onlineforms_report.php";
	document.frm.submit();
...
if($num > 0)
{
	...
	<!-- <form method='post' action="onlineforms_report.php" name="frm" > -->
	 <form method='post' action="onlinerepdis.php" name="frm" > 

    <table class='forumline' align='center' width="90%" >
    <tr>
    	<td Class="Head" colspan='7' align='center'>ONLINE ENQUIRY</td></tr>
	<tr>
        ...
        <tr>
            ...
            <select name="status" onChange="reload1()" >       
                ...
                <option value="1" <?php echo $sel1; ?>> Applied</option>
  
                <option value="2" <?php echo $sel2; ?>> Accepted </option>
  
                <option value="3" <?php echo $sel3; ?>> Withdrawn </option>
	...
	if($_POST)
	{
		...
		$sql="select count(id) from student_m_online where id is not null and academic_year = '$academic_year'";
