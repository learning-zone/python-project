...
if((isset($search)) or (!$app))
{	

	$mod="SELECT * FROM `student_m_pre` WHERE id='$appl_no'";
 ...
 <form name='frm' method='post' ENCTYPE="multipart/form-data" action='modify1.php'>

 <input type="hidden" name="appl_no" value="<?php $appl_no ?>">
...
?>
<table align='center' width='90%' class='forumline' border='1' >
<tr>
	<td align='center' class='head'>ONLINE APPLICATION FORM</td>
</tr>
<tr><td align='center'>

<table border='0' align='center' width='100%' class='forumline'>

<tr height="25"><td class="submenu" colspan="5">

<div id=123A style="float: left; text-align: left;"><b>Admission details </b></div>

<div id=123B style="float: right; text-align: right;">

<a href="javascript:OpenWind2('../passport/register_exec.php?student_id=<?=$appl_no?>')" >

<input type="button" class="bgbutton" value="Add additional information">
...
<td nowrap>&nbsp;&nbsp;Application Number</td>
		...
		<td width="15%">&nbsp;&nbsp;Branchname<font color="#FF0000">*</font></td>
		...
		if(!$branch)
			...
			$branch=$mod2['course_admitted'];
			 ...
			 echo Sem; ?> <font color="#FF0000">*</font></td>

        <td nowrap><div id="txtHint9" class="inline">  
...
<td nowrap>&nbsp;&nbsp;Academic Year<font color="#FF0000">*</font></td>
		...
		if(!$branch)
			...
			?>
			  ...
			  <td nowrap>&nbsp;&nbsp;Admission Category<font color="#FF0000">*</font></td>
...
<tr><td>
 ...
 <table border='0' align='center' width='100%' class='forumline'>
    ...
    <td nowrap>&nbsp;&nbsp;Student Name <font color="#FF0000">*</font></td>

    <td><input type="text" name="fname" value="<? echo $mod2[first_name]?>" size=40></td>

      <td nowrap>&nbsp;&nbsp;&nbsp;&nbsp;Last Name <font color="#FF0000">*</font></td>

		<td><input type="text" name="lname" value="<? echo $mod2[last_name]?>" size=40></td>

	<td nowrap>&nbsp;&nbsp;Gender<font color="#FF0000">*</font></td><td>
    ...
    <select name="gender">
      ...
      <option value="F" <?=$sk?>>&nbsp;&nbsp;&nbsp;&nbsp;Female</option>
		...
		<tr height="25"><td nowrap>&nbsp;&nbsp;Date of Birth<font color="#FF0000">*</font></td>
	...
	<td nowrap>&nbsp;&nbsp;Age</td><td><input type="text" name="age_yr" value="<?php echo $age_yr?>" size='2' readonly></td>

	<td nowrap>&nbsp;&nbsp;Mother Tongue<font color="#FF0000">*</font></td>            
     ...
     <tr height="25">
            ...
            <td nowrap>&nbsp;City&nbsp;&nbsp;&nbsp;<input type="text" name="place" value="<?php echo $mod2[place_of_birth]?>"></td>

			<td nowrap>&nbsp;&nbsp;State</td>

			<td nowrap><input type="text" name="dist" value="<?php echo $mod2[birth_disct]?>"></td>
     ...
     <tr height="25"> 
      ...
      <td nowrap>&nbsp;&nbsp;Nationality<font color="#FF0000">*</font></td>
