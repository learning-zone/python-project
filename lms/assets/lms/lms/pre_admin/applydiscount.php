...
function frm_reload()
{
	document.frm.action='applydiscount.php';
	document.frm.submit();
} 
</script>
...
if($branch!=0)
{
	...
	$sql="select id, first_name, admission_date, last_name, admission_type from $tablename where id is not null and archive='$archive' and academic_year = '$academic_year'";
	if($app_no!='')
	{
	 $sql.=" and id='$app_no'";
	}
