...
function reload()
{
	document.frm.action='add_stud_details.php';
	document.frm.submit();
}
function getAddr()
{
...
/*
 	if($branch!=0 && $sem!=0 && $a_year!=0)
	{
			...
			{
				$var1 = execute("select student_id from student_m where id='$row[0]'") or die(mysql_error());
				$row1 = fetchrow($var1);
	...
	*/
 ?>
 <form name='frm' method='post' ENCTYPE="multipart/form-data" action='res1.php'>
 <input type="hidden" name="tempiddet" value="<?=$tempiddet?>">
...
<tr height="25"><td class="submenu" colspan="5" nowrap>
<div id=123A style="float: left; text-align: left;"><b>Admission details </b></div>
<div id=123B style="float: right; text-align: right;">
<a href="javascript:OpenWind2('../passport/register_exec.php?student_id=<?=$tempiddet?>')" >
...
<!-- <td nowrap>&nbsp;&nbsp;Application Number</td>
		<td><input name="appl_num" type="text" value="" size="34" readonly></td> -->
...
<td align='center' colspan=1>Guardian Details
 ...
 <tr>
	<td>&nbsp;&nbsp;E-mail</td>
	<td align='center'><input type="text" name="femail" value="<?php echo $femail?>"></td>
	<td align='center'><input type="text" name="memail" value="<?php echo $memail?>" ></td>
	<td align='center'><input type="text" name="gemail" value="<?php echo $gemail?>" ></td>
 </tr>
 <tr>
