...
$sql="select id,first_name,admission_date from student_m_pre where id is not null and academic_year = '$academic_year' and archive = 'N'";	
...
function redirect()
{
	document.frm.action = "enrolleddids_xl.php";
	document.frm.submit();
}
...
<body>
<!-- <form method="post" name="frm" action="enrolleddids_xl.php"> -->
...
<tr><td align='center' class='head' colspan='5'>List of Students Enrolled for - <?php echo  $branchname."-".$semname ; ?> </td></tr>
...
<td Class="rowpic" align='center' nowrap="nowrap">Student ID</td>
...
<?php
  ...
  $sno=1;
...

	{
		...
		$sql2 = "select student_id from student_m where admission_id = '$r[id]'";
        ...
        <td align="center">&nbsp;&nbsp;<? echo $studid ; ?></td>
