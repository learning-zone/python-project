...
function reload()
{
	document.frm.action='apply_online.php';
	document.frm.submit();
}
function getAddr()
{
...
$usn = $_POST['usn'];
 ...
 <div align="left"><a href = "Online_link.php"><input type="button" class = "bgbutton" name = "edit" value = "Click here if already Applied"></a></div>
...
frmvalidator.addValidation("msgphone","req","Please  enter mobile number");
