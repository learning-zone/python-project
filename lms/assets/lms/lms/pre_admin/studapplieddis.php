...
$sqlDisplay="SELECT `id`, `first_name`, `admission_date`, `dob` FROM `student_m_online` WHERE id is not null AND academic_year = '$academic_year' AND `enquiry_type`='Walk-in'";
...
function redirect()
{
	document.frm.action = "studapplieddis_xl.php";
	document.frm.submit();
}
...
<body>
<!-- <form method="post" name="frm" action="studapplieddis_xl.php"> -->
...
<tr><td align='center' class='head' colspan='5'>List of <?php echo $statusname;  ?> Students Applied for admission - <?php echo  $branchname."-".$semname ; ?> </td></tr>
<tr height='25' >
