...
$file_name= "student_Applied_for_admission_report.xls";
...
$sql="select id,first_name,admission_date,age from student_m_pre where id is not null and academic_year = '$academic_year'";
		if($status=='1')
		{
		$sql.= " and archive ='Y'";
		}
