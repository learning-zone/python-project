...
while($r21=fetcharray($sql21))
{
	...
	if($rs_section[0]!='' && $rs_section[1]!='')
	{
		...
		if($sql_id[0]==1 || $sql_id[0]==3)
		{
			...
			$sql123="select b.id,b.student_id,b.first_name,b.last_name,b.admission_id from student_course a,student_m b where a.acc_year='$a_year' and a.stu_id=b.id and  b.archive='N' and a.sub='$subject' and a.sub_sec='$class_section_id' group by a.stu_id order by b.first_name";
