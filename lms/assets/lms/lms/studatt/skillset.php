...
if($sem=='0' || $sem=='')
  ...
  echo "<tr height='25'>
    ...
    <td nowrap align='center'>&nbsp;$r1[student_id]</td>";
		...
		?><td nowrap align='center'>&nbsp;<a href= "javascript:OpenWind2('addskill.php?course=<?=$course?>&sem=<?=$sem?>&examid=<?=$examname?>&studentid=<?=$r1[id]?>&class_section_id=<?=$class_section_id?>&stundetname=<?=$r1[first_name]?>&student_id=<?=$r1[student_id]?>')">ADD SKILL			
</a>
    </td></tr><?php
