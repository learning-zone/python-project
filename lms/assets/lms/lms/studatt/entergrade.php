...
{	
    ...
    <tr height="10"><td colspan=6 align='center' class='head'>Grade  </td></tr>
    <tr >
    ...
    <tr >
        ...
        <td align="center" width="30" nowrap><a href="javascript:OpenWind2('add_grade.php?subname=<?=$subject_id_dis[0]?>&branch=<?=$branch?>&sem=<?=$sem?>&class_section_id=<?=$class_section?>&subject=<?=$subject?>&sess=s')"><input type="button" name="update" value="Add Grade"  class='bgbutton'></a></td>
    </tr>
