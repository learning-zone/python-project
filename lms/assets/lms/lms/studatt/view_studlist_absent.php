...
<table border="1" class="forumline" cellpadding="0" cellspacing="0" align="center" width='80%' >
<tr>
  <td align='center' class='head' colspan='4'>Student Absent Report</td>
<?php
if($clid !='a')
...
while($r1=fetcharray($sql1))
{
	...
	{
		$morningp1=fetcharray(execute("SELECT count(id) FROM $attandanceTablename where att_date='$ststemdate'  and sec='$r2[0]' and mor='A'"));
		$noonngp1=fetcharray(execute("SELECT count(id) FROM $attandanceTablename where att_date='$ststemdate'  and sec='$r2[0]' and after='A'"));
		if($morningp1[0]>0 or $noonngp1[0]>0)
		{
			echo "<tr height='30'><td class='rowpic' colspan='4'>&nbsp;&nbsp;&nbsp;Class : $r1[1]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Section : $r2[1]
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date : $adate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td></tr>";
	...
	<td valign='top' colspan='2'><table border=1 class=forumline cellpadding="0" cellspacing="0" align=center  width='100%'>
		<tr height='25'><td align="center" Class="rowpic">Sl.No</td><td align="center"  Class="rowpic">Student ID</td>
		  ...
		  <td align="center"  Class="rowpic">MOR</td>
	    <td align="center"  Class="rowpic">NOON</td></tr>
				<?php
				$flag1=0;
				$k=0;
		...
		<tr class='row<?php echo $rowclass ?>' height='25'>
		  ...
		  <td align="center"  ><?=$morid?></td>
	    <td align="center"  ><?=$noonid?></td></tr>
						<?php
						$rowclass = 1 - $rowclass;
						$k++;
					}
