...
while($r1=fetcharray($rs_ec))
{
	...
	{	
		?>
	    <td valign='bottom' align='center' width="5.5%"><?php echo round($pert, 2);?><br>
	    <img src="<?=$imagepath?>" height="<?=$iact?>" width=20></td>
		<?php
	}
	else
	{
...
{	
	?>
    <td valign='bottom' align='center' width="5.5%"><?php echo round($avrpert, 2);?><br>
    <img src="a.gif" height="<?=$iact?>" width=20></td>
	<?php
}
else
{
...
while($r1=fetcharray($rs_ec))
{
	...
	$r3=fetcharray($rs_ec1);
	$avssts=$r3[rfg];
	echo "<td align='center' width='5.5%'>$examnamed[0]<br>$avssts</td>";
	echo "<td width='5.5%'>&nbsp;</td>";
	$ct++;
}
for($zz=0;$zz<$ks1;$zz++)
...
echo "<td align='center' width='5.5%'>AVG</td>";
echo "<td width='5%'>&nbsp;</td>";
?>
    </tr>
</table></td>
...
<tr><td colspan='2'>
	...
	{
		echo "<div><b>Marks for selected examination not entered...</b></div>";
	}
}
?>
<br>
