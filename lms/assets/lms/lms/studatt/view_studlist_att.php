...
<tr><td align='center' class='head' colspan='4'>Student Consolidate Attendance Report</td>
<?php
if($clid !='a')
...
while($r1=fetcharray($sql1))
{
	...
	{
		echo "<tr height='30'><td class='rowpic' colspan='4'>&nbsp;&nbsp;&nbsp;Class : $r1[1]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Section : $r2[1]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Section : $r2[1]
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date : $adate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td></tr>";
