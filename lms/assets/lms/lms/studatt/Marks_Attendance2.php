...
?>
  ...
  echo "<tr>
	...
	?><a href= "javascript:OpenWind2('Marks_card.php?stuid=<?=$r1[student_id]?>&stuname=<?=$r1[first_name]?>&branch=<?=$branch?>&sem=<?=$sem?>&examid=<?=$examname?>&studentid=<?=$r1[id]?>&class_section_id=<?=$class_section_id?>&stundetname=<?=$r1[first_name]?>&admissionid=<?=$r1[admission_id]?>&student_id=<?=$r1[student_id]?>')">
	VIEW
