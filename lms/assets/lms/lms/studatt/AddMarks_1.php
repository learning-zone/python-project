...
?>
  ...
  <tr>
    ...
    <td width="27%" align="center">&nbsp;Student Id</td>
  ...
  echo "<tr>
	...
	?><a href= "javascript:OpenWind2('AddMarks1.php?course=<?=$branch?>&sem=<?=$sem?>&examid=<?=$examname?>&studentid=<?=$r1[id]?>&class_section_id=<?=$class_section_id?>&stundetname=<?=$r1[first_name]?>&student_id=<?=$r1[student_id]?>')">ADD MARKS
