...
<tr>
   <td style="border:2px solid black;" align='center'  width="30%"><input  type="image"  src="http://sis.focusedu.net/renew/pyp/smiley.PNG"/>&nbsp;&nbsp;<input  type="image"  src="http://sis.focusedu.net/renew/pyp/smiley.PNG"/>&nbsp;&nbsp;<input  type="image"  src="http://sis.focusedu.net/renew/pyp/smiley.PNG"/></td>
  	<td style="border:2px solid black;" align='center'  width="30%"> <input type="image"  src="http://sis.focusedu.net/renew/pyp/smiley.PNG"/>&nbsp;&nbsp;<input  type="image"  src="http://sis.focusedu.net/renew/pyp/smiley.PNG"/></td>
  	<td  style="border:2px solid black;" align='center' width="30%"><input  type="image"  src="http://sis.focusedu.net/renew/pyp/smiley.PNG"/></td>
    </tr>
  </table>
  <table width="90%"  align="center" border="0" cellspacing="0" cellpadding="3"> 
<tr>
...
?>  
  ...
  <table  width="90%"  align="center" border="0" cellspacing="0" cellpadding="3">
  <tr>
  <td  align='center'><input  type="image"  src="http://sis.focusedu.net/renew/pyp/habits.PNG"/></td>
    </tr>
	<tr>
    <td align="center" ><h3>Work Habits/Scoial Development Record</h3></td>
...
while($cen_i1=fetcharray($cen_i))
{
	...
	echo "<tr><td align='center'> <input  type='image'  src='http://sis.focusedu.net/renew/pyp/ideas.PNG'/></td></tr><tr>
