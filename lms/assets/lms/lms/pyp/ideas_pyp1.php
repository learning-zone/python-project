...
$skills=$_POST['skills'];
$sql2=execute("select * from ideas where id='$idn'");
...
if(isset($_POST['update']))
{
	...
	for($i=0;$i<sizeof($cid);$i++)
	{
		...
		$sql23="update  ideas_1 set idea='$skills', posi='$priority' where id='$cid[$i]'";
...
if(isset($_POST['save']))
{
	...
	{
		$sql2=execute("select * from   ideas_1 where acc_year='$accyeardet' and class='$class' and master_ideas='$skill1' and 	idea='$skills' and posi='$priority'");
		if(rowcount($sql2)>=1)
		{
			?>
			<Script language="JavaScript">
...
<br>
  ...
  <br>
  <?php
$sql3=execute("select id, idea , posi from   ideas_1 where acc_year='$accyeardet' and class='$class' and master_ideas='$skill2'");
if(rowcount($sql3)>=1)
{	
	?>
<br>
