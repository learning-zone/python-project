...
<td class='row3' align="center">Magzine No</td>
<td class='row3' align="center">&nbsp;Title</td>
<td class='row3' align="center">Subscription No</td>
<td class='row3' align="center">Magzine Date</td>
...
{    
	...
	$ssql="select magazine_no,title,magazine_sub_no,magazine_date,amount,month,ssp_type from lib_magazine where  library='$lib' and magazine_no like 'M-%' ";
...
{
	$ssql="select magazine_no,title,magazine_sub_no,magazine_date,amount,month,ssp_type  from lib_magazine where magazine_no like 'M-%' ";
...
else
{
	...
	for($i=$SeekPos;$i<$MAX;$i++)
	{
		...
		echo "<td align='left'>&nbsp;";
	/*	
		$mag_date=$r_sql['magazine_date'];
		$dateArray=explode('-',$mag_date);
		$acq_yy=$dateArray[0];
		$acq_mm=$dateArray[1];
		$acq_dd=$dateArray[2];
		$magazine_date="$acq_dd-$acq_mm-$acq_yy";*/
		
				
		$mag_date=$r_sql['magazine_date'];
		$date=explode('-',$mag_date);
		$magazine_date="$date[2]-$date[1]-$date[0]";
...
<form name="frm" action="brief_med_rep3.php">
