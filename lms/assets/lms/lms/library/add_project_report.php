...
/*	if(document.book.library.selectedIndex=="")
	...
	document.book.action = "add_project_det.php";
...
<BODY>
<form method="POST" name="book" action="add_project_report.php">
<input type="hidden" name="media" value="<?=$media?>">
<input type="hidden" name="accNo" value="<?=$accNo?>">
<table class='forumline' width="90%" border=0 cellpadding=1 cellspacing=1 align=center><br/>
	<tr hight=30>
		<td class="head" colspan=4 align="center">Add Project Report Details</td>
	</tr>
   <tr>
   ...
   <?php
      ...
      <tr>
		<td width="14%" nowrap="nowrap">&nbsp;&nbsp;&nbsp;Accession No</td>
		<td width="43%">
		<?php
	...
	if($library==2 and $register==4) //MYP TEXT BOOK
	{
		...
		/*if($library!=null)
			{
				$var = "select acc_no from lib_proj_acc_det where library='$library' order by acc_no desc limit 1";
				$varrr=execute($var);
				$vae=fetcharray($varrr);
				if($vae[acc_no]=='')
					{
		...
		<table border="0" width="80%" >
			 <tr>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;From</td>
				<td title="Press Enter after filling data">No of Copies</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To</td>
			</tr>
		    <tr>
		...
		<td width="19%" colspan=1>Book Type</td>
		<?php
		$sel1="";
		$sel2="";
		$sel3="";
	...
	<tr>
		<td>&nbsp;&nbsp;&nbsp;Title</td>
		<td><input type="text" name="title" value="<?=$title?>" size="36" onKeydown="first_caps(this.form.title)"></td>
		<td>Classification No</td>
		<td><input type="text" name="class_no" value=""></td>
	</tr>
	<tr>
		<td>&nbsp;&nbsp;&nbsp;Call No</td>
		<td><input type="text" name="call_no" value="" size="19"></td>
		<td>Author</td>
	...
	<tr>
		...
		<td><input type="text" name="guide_name" value="<?=$guide_name?>"></td>
	</tr>
	<tr>
		<td>&nbsp;&nbsp;&nbsp;Course</td>
		<td><input type="text" name="course" value="<?=$course?>"></td>
		<td>Class</td>
		<td><input type="text" name="class_name" value="<?=$class_name?>"></td>
	</tr>
	<tr height='25'>
...
<br>
<div align="center"><input type="button" value=" Add Media " class='bgbutton' name="add" onClick="frm_add()"></div>
<?php
