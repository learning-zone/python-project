...
function frm_submit()
{
	document.form1.action='view_media_usage_analysis.php'
...
<?
	...
	echo "<tr><td class='head' align='center' colspan=3>Media Usage Analysis</td></tr>";
	echo "<tr>";
	/*
	echo "<td>";
	...
	*/
	...
	//if($register !=0 || $register==-1)
	{
		...
		echo "</td>";
		echo "<td>";
		echo "<select name=media_mode onChange='javascript:document.form1.submit()'>";
		echo "<option value='0' selected >--- Select Media Mode ---</option>";
		$sel1="";
		$sel2="";
		if($media_mode == 'I')
			$sel1 = "selected";
		elseif($media_mode=='R')
			$sel2 = "selected";
		echo "<option value='I' $sel1 >Issue</option>";
		echo "<option value='R' $sel2 >Reference</option>";

		echo "</select>";
		echo "</td>";
		echo "</tr>";

		if($media_mode !='0' && $media_mode !="")
		{
			echo "<tr>";
			echo "<td align='right'>";
				echo " Media &nbsp;";
			...
			//echo "<option value='4'  >Bound Volume</option>";
			if($media_mode !='I')
			{
				echo "<option value='7'  >Magazine/Journal</option>";
			}
