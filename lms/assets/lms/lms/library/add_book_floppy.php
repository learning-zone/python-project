...
function frm_add()
{
	...
	else if(document.book.register.selectedIndex=="")
	{
		alert("Please select Register ");
		document.book.register.focus();
		return false;
	}
	else if (document.book.acc_from.value=="" || document.book.acc_to.value=="" )
	{
		alert("Enter Accession No From and To ");
		document.book.acc_from.focus();
		return false;
	}
	else if (acc_from > acc_to)
	{
	...
	{
		document.book.action = "ins_book_floppy.php";
...
<form method="POST" name="book" action="add_book_floppy.php">
...
<table border="0" width="90%" align='center' cellspacing="1" cellpadding="1"  class='forumline' >
	<tr height='30'>
		<td colspan=4 align="center" class='head'>Add Book Floopy Details</td>
	</tr>
	<tr>
		<td class="topictitle" width="120" align="left" height="22" ><b><font color="#000000">Library</font></b><font color="#FF0000">*</font></td>
		...
		<td><font color='#000000' align='right'><b>Register</b></font> <font color=#FF0000>*</font></td>
	...
	<tr>
		<td><font color="#000000"><b>Accession No</b></font></td>
		<td>
		<?php
		if($library!=null)
			{
				$var = "select acc_no from lib_floppy_acc_det where library='$library' order by acc_no desc limit 1";
				$varrr=execute($var);
		...
		<td><font color="#000000" align='right'><b>Floppy Type</b></font></td>
		<td>
		<?php
		$sel1="";
		$sel2="";
	...
	<tr>
		<td><font color="#000000"><b>Title</b></font></td>
	...
	<tr>
		<td><font color="#000000"><b>Author</b></font></td>
		<td><input type="text" name="author" value="<?=$author?>"></td>
		<td><font color="#000000"><b>Rack</b></font></td>
		<td><input type="text" name="rack" value="<?=$rack?>"></td>
	</tr>
	<tr>
		<td><font color="#000000"><b>Source</b></font></td>
		<td><input type="text" name="source" value="<?=$source?>" size="10"></td>
		<td><font color="#000000"><b>Source Acc No</b></font></td>
		<td><input type="text" name="source_acc_no" value="<?=$source_acc_no?>"></td>
	</tr>	
	<tr>
		<td><font color="#000000"><b>Publication Date </b></font></td>
		<td>
		<?php
		$c_date=getdate();
		$MyDay=$c_date["mday"];
		...
		<td><font color="#000000"><b>Date of Acquiring</b></font></td>
		<td>
		<?php
		$c_date=getdate();
		$MyDay=$c_date["mday"];
	...
	<tr>
		<td><font color="#a65353"><b>Call No</b></font></td>
        <td>
		<table border="0" width="80%">
			<tr>
				<td><input type="text" name="call_no" value="<?php echo $call_no?>" size="19"></td>
			</tr>
		</table>
		</td>
	...
	<tr>
		<td><font color="#000000"><b>Volume No</b></font></td>
		<td><input type="text" name="volume" value="<?=$volume?>"></td>
		<td><font color="#000000"><b>Issue No</b></font></td>
		<td><input type="text" name="issue" value="<?=$issue?>"></td>
	</tr>
	<tr height='25'>
		<td class="row3" colspan=4 align="center">Key Words</td>
	</tr>
	<tr>
		<td><b>Key Word1</b></td>
	...
	<tr>
		<td colspan=4 align="center"><input type="submit" value="Add Media" name="add" class='bgbutton' onClick="return frm_add()"></td>
	</tr>
</table>
<?php
