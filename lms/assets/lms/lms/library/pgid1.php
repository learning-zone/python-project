...
if($num>0)
{
	 ...
	 for($i=$SeekPos;$i<$MAX;$i++)
	 {
			...
			$temp = $r1[addr];
			if($r1[course_admitted]=='6')
		     {
				$br="MBA";
				$duration = " 2 Years";
		     }
			 if($r1[course_admitted]=='7')
		     {
				$br="MCA";
				$duration = " 3 Years";

		     }
			 if($r1[course_admitted]=='8' or $r1[course_admitted]=='9' or $r1[course_admitted]=='14')
		     {
				$br="MTech";
				$duration = " 2 Years";
		     }
			 if($r1[course_admitted]=='10' or $r1[course_admitted]=='11' or $r1[course_admitted]=='12' or $r1[course_admitted]=='13')
		     {
				$br="Phd";
				$duration = " 2 Years";
		     }
			...
			<td width='50%'>
				<table border="0" width='100%' height='100' cellspacing=0 cellpadding=0 background="../images/rnsit11.jpg" >
					...
					<tr>
						...
						<td>
							:&nbsp;<font size='0.8'><b><?php echo $br ?></b></font>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font size='0.8'><b>Branch</b></font>&nbsp;&nbsp;&nbsp;:&nbsp;
							<font size='0.8'><b><?php echo $sql[0] ?></b></font></td>
					</tr>
					<tr>
						<td>&nbsp;&nbsp;<font size='0.8'><b>Adm Year</b></font>&nbsp;&nbsp;</td>
						<td>:&nbsp;<font size='0.8'><b><?php echo $ac ?>-<?php echo $aca1 ?></b></font>
							&nbsp;&nbsp;&nbsp;<font size='0.8'><b>Duration&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo $duration ?></b></font>
