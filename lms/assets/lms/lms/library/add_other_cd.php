...
function frm_add()
{
	...
	if (acc_from > acc_to)
	{
		alert("Accession No: From Number can't be greater than  To Number  ");
		document.book.acc_from.focus();
		return false;
	}
	...
	document.book.action = "ins_other_cd.php";
...
<BODY>
<form method="POST" name="book" action="add_other_cd.php">
<input type="hidden" name="media" value="<?=$media?>">
<input type="hidden" name="accNo" value="<?=$accNo?>">
<table  width="90%" class='forumline' align=center cellpadding=1 cellspacing=1 border=0 >
	<tr height=30>
		<td align="center" Class="head" colspan='4'>Add CD Details</td>
	</tr>
	<tr>
		<td width="120" align="left">Library<font color="#FF0000">*</td>
	...
	<tr>
		<td>Title</td>
		<td><input type="text" name="title" value="<?=$title?>" size="37" onKeydown="first_caps(this.form.title)"></td>
		<td colspan=1>Classification No</td>
	...
	<tr>
		...
		<td><font color="#000000">Call No</td>         
	...
	<tr>
		<td colspan=4 align="center"><input type="button" value=" Add Media " class='bgbutton' name="add" onClick="frm_add()"></td>
	</tr>
</table>
<?php
