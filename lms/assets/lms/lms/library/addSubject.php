...
<FORM id="frm" NAME="frm" ACTION="" METHOD="post">
	...
	<table align='center' class="forumline" width='90%' >
			<tr height="25">
				<td align='center' Class='head' colspan="3">BOOK TITLE</td>
			</tr>
			<tr height="25">
				<td colspan="2" nowrap align="right">Book Title&nbsp;&nbsp;</td>
        ...
        <input type="submit"  value="Add" onClick="adds_onclick()" class='bgbutton' style="width:60px; height:22px"></p>
         	...
         	<table align='center' class=forumline width='90%' >
			<tr height="25">
				<td align='center' Class='head' colspan=5>BOOK SUBTITLE</td>
			</tr>
            ...
            <tr height="25">
			  ...
			  <a href="javascript:void(0);" onClick="OpenWinds('addSubject_edt.php', 'OpenWinds',400,400)">
              <img src="../images/edit.png" height="30" width="30" title="Change Book Title"></a>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td></tr>
			<tr height="25">
				<td colspan="2" nowrap align="right">Book Sub-Title &nbsp;&nbsp;</td>
...
<?php
	   ...
	   $result=execute("SELECT a.*,b.* FROM lib_book_title a, lib_book_subtitle b WHERE  a.id = b.lib_book_title_id AND a.status=1 AND b.status=1");
	  ...
	  <table class='forumline' align='center' width='90%'>
		<tr height='22' >
			...
			<td width="33%" align='left' Class="head">Book Title</td>
			<td width="46%" align='left' Class="head">&nbsp;&nbsp;Book Subtitle</td>
	   </tr>
       <?
	   	    $i=0;
            $rowclass=1;
