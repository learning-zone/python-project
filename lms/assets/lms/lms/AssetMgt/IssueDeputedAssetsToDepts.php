...
<script language="JavaScript">
	function RefreshMe()
	{
		document.frm.action="IssueDeputedAssetsToDepts.php";
		document.frm.submit();
	}
</script>
</head>
...
?>
<body>
<form name="frm" method="post" action="InsIssueDeputedAssetsToDepts.php">
...
$qry1=execute("select a.*,b.item_code,c.location from deputation_gatepass_details a,individual_asset_details b,location_master c,dept_no d where a.location_id=c.id and a.item_code_id=b.id and a.returned='YES' and a.issue_status='NO' and a.completely_received='NO' and c.dept_id=d.dpt_id and d.dpt_id=$dept") or die(error_description());
...
<div align=center>
<input type="submit" value="Issue Assets To Department" class=bgbutton>
</div>
<?}?>
</form>
</body>
