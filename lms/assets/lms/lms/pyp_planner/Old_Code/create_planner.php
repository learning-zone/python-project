...
<FORM id="frm" NAME="frm" ACTION="" METHOD="post">
	...
	<table align='center' class=forumline width='50%' >
          ...
          <tr height="25">
				...
				<td width="76%"><INPUT TYPE="text"  NAME="title" value="<?=$title?>" size="60"></td>
	      </tr>
            <tr height="25">
				<td colspan="2" nowrap align="right">Duration From&nbsp;&nbsp;</td>
				<td width="76%"><INPUT TYPE="text"  NAME="adate" value="<?=$adate?>" size="60">
            ...
            <tr height="25">
			    ...
			    <td width="76%"><INPUT TYPE="text"  NAME="bdate" value="<?=$bdate?>" size="60">
...
<?php
	   ...
	   $result=mysql_query("SELECT * FROM `pyp_planner` WHERE `status`=1 ORDER BY `id`");
	...
	$grade=mysql_fetch_array(mysql_query("SELECT `year_name` FROM `course_year` WHERE `year_id`=$row[grade] AND status=1"));				
            ...
            <td  align='center' >
            <input type="button"  value="&nbsp;&nbsp;&nbsp; Edit &nbsp;&nbsp;&nbsp;" onclick ="OpenWind2('create_planner_edt.php?id=<?=$row[id]?>&Type=group_edt', 'OpenWind2',800,800)" class="bgbutton"/>
